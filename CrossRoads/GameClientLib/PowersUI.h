...
typedef struct PowersUIState
{
	...
	PowerListNode **eaCombatPowerStatePowerListNodes;
		// a list built from the eaPurposeListNodes for the character's combat power state powers.
	
	StashTable statePowerListNodesHash;
		// a stash of eaPurposeListNodes powerDef's to their corresponding list of PowerListNodes
	...
	bool bTalentTreesUsePowersPurpose;
		// normally, TalenTrees will add their own PowersUIPurposeNode pet tree and not by the PowerDefs purpose
		// if this is set, it will add TalentTree powers to PowersUIPurposeNode based on their PowerDef
