...
// Mouse Targeting
Entity * target_SelectUnderMouseEx(Entity *e, PowerTarget *pPowerTarget, U32 target_type_req, U32 target_type_exc, Vec3 worldPos, bool bSelectable, bool bIsClick, bool preferInteractables, bool bRecordDepth);
Entity * target_SelectUnderMouse(Entity *e, U32 target_type_req, U32 target_type_exc, Vec3 worldPos, bool bSelectable, bool bIsClick, bool preferInteractables, bool bRecordDepth);
