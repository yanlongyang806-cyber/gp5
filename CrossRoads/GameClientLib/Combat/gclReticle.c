...
F32 exprGetTargetingReticleXPos(void)
{
	...
	// Because UIGens only get drawn into the UI Viewport, we need to
	// take that into account.
	return reticle.iReticlePosX - g_ui_State.viewportMin[0];
}
...
F32 exprGetTargetingReticleYPos(void)
{
	...
	// Because UIGens only get drawn into the UI Viewport, we need to
	// take that into account.
	return reticle.iReticlePosY - g_ui_State.viewportMin[1];
}
