...
#define DISABLED "Disabled\n"
	...
	}
	{
		...
		addAutoWidget(group, parse_tex_opt, "Flags|sRGB", &toDoc->texopt, true, toeOnDataChanged, toDoc, &params_align_flags, "Run-time option.  Enables conversion from sRGB space. Should be set for any texture used as a diffuse map, and unset for other textures.");
