...
typedef struct HeadShotFrame HeadShotFrame;
...
typedef struct CECostumeGroup
{
	...
	int index;
	ContactCostume ***peaExtraCostumes;
	...
	UILabel *pHeadshotBorderFrameLabel;
	...
	MEField *pHeadshotBorderFrameField;
	MEField *pHeadshotStyleField;

	UICheckButton *pStyleOverridesCheckButton;
	UICheckButton *pFrameOverrideCheckButton;

	HeadShotFrame **eaFrames;

	UILabel *pOverrideBackground;
	UILabel *pOverrideSky;
	UILabel *pOverrideFX;
	UILabel *pOverrideFrame;

	MEField *pOverrideBackgroundField;
	MEField *pOverrideSkyField;
	MEField *pOverrideFXField;
	MEField *pOverrideFrameField;
} CECostumeGroup;
...
typedef struct CESpecialDialogGroup
{
	...
	CECostumeGroup **eaCostumeGroups;
...
typedef struct CEOfferGroup
{
	...
	UILabel *pRequireAllAllegianceLabel;
	...
	MEField *pRequireAllAllegianceField;
...
typedef struct ContactEditDoc
{
	...
	UILabel *pStickerBookCollectionLabel;
	...
	MEField *pStickerBookCollectionField;
