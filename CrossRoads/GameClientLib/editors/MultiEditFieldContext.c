...
{
	return MEContextAddMinMaxIndex(eType, min, max, step, pchFieldName, -1, pchDisplayName, pchToolTip);
}

MEFieldContextEntry* MEContextAddMinMaxMsg(MEFieldType eType, F32 min, F32 max, F32 step, const char *pchFieldName, const char *pchDisplayName, const char *pchToolTip)
{
	return MEContextAddMinMaxIndexMsg(eType, min, max, step, pchFieldName, -1, pchDisplayName, pchToolTip);
}
...
MEFieldContextEntry* MEContextAddMinMaxIndexMsg(MEFieldType eType, F32 min, F32 max, F32 step, const char *pchFieldName, int iIndex, const char *pchDisplayName, const char *pchToolTip)
{
	MEFieldContextEntry* pEntry = MEContextAddMinMaxIndex(eType, min, max, step, pchFieldName, iIndex, "", "");
	ui_LabelSetMessage(pEntry->pLabel, pchDisplayName);
	ui_WidgetSetTooltipMessage(UI_WIDGET(pEntry->pLabel), pchToolTip);
	return pEntry;
}
