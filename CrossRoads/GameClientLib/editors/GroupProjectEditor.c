...
static void gpe_initGroupProjectColumns(METable *pTable)
{
	...
	METableAddGlobalDictColumn(pTable, "Unlocks", "Unlock", 240, GPE_GROUP_MAIN, kMEFieldType_ValidatedTextEntry, g_GroupProjectUnlockDict, "resourceName");
	METableAddGlobalDictColumn(pTable, "Tasks", "Task", 240, GPE_GROUP_MAIN, kMEFieldType_ValidatedTextEntry, g_DonationTaskDict, "resourceName");
	METableAddGlobalDictColumn(pTable, "Valid Numerics", "ValidNumeric", 240, GPE_GROUP_MAIN, kMEFieldType_ValidatedTextEntry, g_GroupProjectNumericDict, "resourceName");
    ...
    METableAddGlobalDictColumn(pTable, "Contribution Numeric", "contributionNumeric", 240, GPE_GROUP_MAIN, kMEFieldType_ValidatedTextEntry, "ItemDef", "resourceName");
    METableAddGlobalDictColumn(pTable, "Lifetime Contribution Numeric", "lifetimeContributionNumeric", 240, GPE_GROUP_MAIN, kMEFieldType_ValidatedTextEntry, "ItemDef", "resourceName");
	...
	METableAddGlobalDictColumn(pTable, "Power Trees", "PowerTree", 240, GPE_GROUP_MAIN, kMEFieldType_ValidatedTextEntry, "PowerTreeDef", "resourceName");
...
static void gpe_initContactColumns(METable *pTable)
{
	...
	METableAddGlobalDictSubColumn(pTable, id, "Contact", "contactDef", 240, GPE_SUBGROUP_CONTACTS, kMEFieldType_TextEntry, "ContactDef", "resourceName");
	METableAddGlobalDictSubColumn(pTable, id, "Required Unlocks", "RequiredUnlock", 240, GPE_SUBGROUP_CONTACTS, kMEFieldType_TextEntry, g_GroupProjectUnlockDict, "resourceName");
}
...
static void gpe_init(MultiEditEMDoc *pEditorDoc)
{
	if (!gpeWindow) {
		...
		// Request resources
		resSubscribeToInfoIndex(g_DonationTaskDict, true);
		resSubscribeToInfoIndex(g_GroupProjectUnlockDict, true);
		resSubscribeToInfoIndex(g_GroupProjectNumericDict, true);
		resSubscribeToInfoIndex("ContactDef", true);
		resSubscribeToInfoIndex("PowerTreeDef", true);
		resSubscribeToInfoIndex("ItemDef", true);
	}
