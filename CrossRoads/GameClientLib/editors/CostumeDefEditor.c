...
void costumeDefEdit_UpdateMaterialFxSwaps(CostumeEditDefDoc* pDefDoc)
{
	...
	for (i = 0; i < numFxSwap; i++) {
		...
		if (!pFxSwapGroup->pFxOldField) {
			pFxSwapGroup->pFxOldField = MEFieldCreateSimpleGlobalDictionary(kMEFieldType_TextEntry, pOldFxSwap, pDefDoc->pCurrentMatDef->pOptions->eaFXSwap[i], parse_PCFXSwap, "pcOldName", "DynFxInfo", "ResourceName");
		...
		if (!pFxSwapGroup->pFxNewField) {
			pFxSwapGroup->pFxNewField = MEFieldCreateSimpleGlobalDictionary(kMEFieldType_TextEntry, pOldFxSwap, pDefDoc->pCurrentMatDef->pOptions->eaFXSwap[i], parse_PCFXSwap, "pcNewName", "DynFxInfo", "ResourceName");
...
void costumeDefEdit_UpdateGeoOptionsOptions(CostumeEditDefDoc* pDefDoc)
{
	...
	if (!pDefDoc->pGeoOptionsColor0Label) {
		...
		pField = MEFieldCreateSimpleGlobalDictionary(kMEFieldType_ValidatedTextEntry, SAFE_MEMBER2(pDefDoc, pOrigGeoDef, pOptions), SAFE_MEMBER2(pDefDoc, pCurrentGeoDef, pOptions), parse_PCGeometryOptions, "BodyColorSet0", "CostumeColors", "ResourceName");
		if (!pField)
		{
	...
	if (!pDefDoc->pGeoOptionsColor1Label) {
		...
		pField = MEFieldCreateSimpleGlobalDictionary(kMEFieldType_ValidatedTextEntry, SAFE_MEMBER2(pDefDoc, pOrigGeoDef, pOptions), SAFE_MEMBER2(pDefDoc, pCurrentGeoDef, pOptions), parse_PCGeometryOptions, "BodyColorSet1", "CostumeColors", "ResourceName");
		if (!pField)
		{
	...
	if (!pDefDoc->pGeoOptionsColor2Label) {
		...
		pField = MEFieldCreateSimpleGlobalDictionary(kMEFieldType_ValidatedTextEntry, SAFE_MEMBER2(pDefDoc, pOrigGeoDef, pOptions), SAFE_MEMBER2(pDefDoc, pCurrentGeoDef, pOptions), parse_PCGeometryOptions, "BodyColorSet2", "CostumeColors", "ResourceName");
		if (!pField)
		{
	...
	if (!pDefDoc->pGeoOptionsColor3Label) {
		...
		pField = MEFieldCreateSimpleGlobalDictionary(kMEFieldType_ValidatedTextEntry, SAFE_MEMBER2(pDefDoc, pOrigGeoDef, pOptions), SAFE_MEMBER2(pDefDoc, pCurrentGeoDef, pOptions), parse_PCGeometryOptions, "BodyColorSet3", "CostumeColors", "ResourceName");
		if (!pField)
		{
	...
	if (!pDefDoc->pGeoOptionsColorQuadLabel) {
		...
		pField = MEFieldCreateSimpleGlobalDictionary(kMEFieldType_ValidatedTextEntry, SAFE_MEMBER2(pDefDoc, pOrigGeoDef, pOptions), SAFE_MEMBER2(pDefDoc, pCurrentGeoDef, pOptions), parse_PCGeometryOptions, "ColorQuadSet", "CostumeColorQuads", "ResourceName");
		if (!pField)
		{
...
void costumeDefEdit_UpdateGeoFx(CostumeEditDefDoc* pDefDoc)
{
	...
	for (i = 0; i < numFx; i++) {
		...
		if (!pFxGroup->pFxField) {
			pFxGroup->pFxField = MEFieldCreateSimpleGlobalDictionary(kMEFieldType_TextEntry, pOldFx, pDefDoc->pCurrentGeoDef->pOptions->eaFX[i], parse_PCFX, "pcName", "DynFxInfo", "ResourceName");
			if (!pFxGroup->pFxField)
			{
...
void costumeDefEdit_UpdateGeoFxSwaps(CostumeEditDefDoc* pDefDoc)
{
	...
	for (i = 0; i < numFxSwap; i++) {
		...
		if (!pFxSwapGroup->pFxOldField) {
			pFxSwapGroup->pFxOldField = MEFieldCreateSimpleGlobalDictionary(kMEFieldType_TextEntry, pOldFxSwap, pDefDoc->pCurrentGeoDef->pOptions->eaFXSwap[i], parse_PCFXSwap, "pcOldName", "DynFxInfo", "ResourceName");
			if (!pFxSwapGroup->pFxOldField)
			{
		...
		if (!pFxSwapGroup->pFxNewField) {
			pFxSwapGroup->pFxNewField = MEFieldCreateSimpleGlobalDictionary(kMEFieldType_TextEntry, pOldFxSwap, pDefDoc->pCurrentGeoDef->pOptions->eaFXSwap[i], parse_PCFXSwap, "pcNewName", "DynFxInfo", "ResourceName");
			if (!pFxSwapGroup->pFxNewField)
			{
