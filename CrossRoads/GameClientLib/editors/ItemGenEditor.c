...
static void ige_initColumns(METable *pTable)
{
	...
	METableAddEnumColumn(pTable,       "Gem Type",                 "ItemGemType",                    120, IG_GROUP_MAIN, kMEFieldType_Combo, ItemGemTypeEnum);
...
static void ige_initRarityData(METable *pTable)
{
	...
	METableAddExprSubColumn(pTable, id, "Requires Expr", ".Rarity.RequiresExpr", 140, IGR_GROUP_TIER, g_pRewardPlayerContext);
}
