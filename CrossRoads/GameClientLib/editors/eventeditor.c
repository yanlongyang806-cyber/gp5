...
static int eventeditor_CreateFields(EventEditor *editor)
{
	...
	// PowerCategory
	if (typeInfo->hasPower)
		currY = eventeditor_CreateComboForField(editor, EV_MARGIN_W, currY, "Power Category:", PowerCategoriesEnum, NULL, NULL, (char**)&editor->ev.pchPowerCategoryName, true);

	// PowerTag
	if (typeInfo->hasPower)
		currY = eventeditor_CreateComboForField(editor, EV_MARGIN_W, currY, "Power Tag:", PowerTagsEnum, NULL, NULL, (char**)&editor->ev.pchPowerTagName, true);
