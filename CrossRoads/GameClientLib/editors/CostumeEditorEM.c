...
static void costumeEditorEMEnter(EMEditor *pEditor)
{
	...
	resSubscribeToInfoIndex(g_hCostumeSkeletonDict, true);
	resSubscribeToInfoIndex(g_hCostumeBoneDict, true);
	resSubscribeToInfoIndex(g_hCostumeRegionDict, true);
	resSubscribeToInfoIndex(g_hCostumeCategoryDict, true);
	resSubscribeToInfoIndex(g_hCostumeGeometryDict, true);
	resSubscribeToInfoIndex(g_hCostumeGeometryAddDict, true);
	resSubscribeToInfoIndex(g_hCostumeMaterialDict, true);
	resSubscribeToInfoIndex(g_hCostumeMaterialAddDict, true);
	resSubscribeToInfoIndex(g_hCostumeTextureDict, true);
	resSubscribeToInfoIndex(g_hCostumeLayerDict, true);
}
