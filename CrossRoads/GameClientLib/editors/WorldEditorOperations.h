...
void wleOpUndoFunction(SA_PARAM_NN_VALID void *context, SA_PARAM_NN_VALID JournalEntry *entry);
void wleOpFreeFunction(SA_PARAM_NN_VALID void *context, SA_PARAM_NN_VALID JournalEntry *entry);
