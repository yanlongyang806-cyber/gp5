...
static void se_initStoreColumns(METable *pTable)
{
    ...
    METableAddGlobalDictColumn(pTable, "Inherit Discounts From", "inheritDiscountsStoreDef", 200, SE_GROUP_MAIN, kMEFieldType_ValidatedTextEntry, "StoreDef", "resourceName");
