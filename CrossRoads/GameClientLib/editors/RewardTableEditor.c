...
static void rte_ChoiceTypeChangeCallback(METable *pTable, RewardTable *pRewardTable, RewardEntry *pRewardEntry, void *pUserData, bool bInitNotify)
{
	...
	METableSetSubFieldNotApplicable(pTable, pRewardTable, s_RewardTabID, pRewardEntry, "Force Bind", 1);
	...
	METableSetSubFieldNotApplicable(pTable, pRewardTable, s_RewardTabID, pRewardEntry, "Special Reward", 0);
	...
	case kRewardChoiceType_ChoiceVariableCount:
		...
		case kRewardType_ItemWithGems:
			...
			METableSetSubFieldNotApplicable(pTable, pRewardTable, s_RewardTabID, pRewardEntry, "Force Bind", 0);
			break;
		...
		case kRewardType_RewardTable:
			...
			METableSetSubFieldNotApplicable(pTable, pRewardTable, s_RewardTabID, pRewardEntry, "Special Reward", 1);
			break;
...
static void rte_initRewardColumns(METable *pTable)
{
	...
	METableAddSimpleSubColumn(pTable, s_RewardTabID,	"Force Bind", "ForceBind",	128, RTE_SUBGROUP_REWARDS, kMEFieldType_BooleanCombo);
	...
	METableAddSimpleSubColumn(pTable, s_RewardTabID,	 "Special Reward",    "SpecialReward",			80, RTE_SUBGROUP_REWARDS, kMEFieldType_TextEntry );
