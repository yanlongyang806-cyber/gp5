...
typedef struct CostumeEditDyePackStruct CostumeEditDyePackStruct;
...
typedef struct CostumeEditDoc {
	...
	MEField *pDisableBankingField;
	MEField *pBankRateFlyingField;
	MEField *pBankMaxAngleFlyingField;
