...
typedef struct MissionDisplayOverride MissionDisplayOverride;
...
typedef struct MDEDisplayOverrideGroup
{
	MDEMissionGroup *pMissionGroup;

	MissionDisplayOverride ***peaDisplayOverrides;
	MissionDisplayOverride ***peaOrigDisplayOverrides;
	int index;

	UILabel *pSummaryLabel;
	UILabel *pDetailLabel;
	UILabel *pSoundLabel;
...
typedef struct MDEWaypointGroup
{
	...
	UILabel *pMapLabel;
	UILabel *pAlternateMapLabel;
	UILabel *pAnyMapLabel;

	MEField *pTypeField;
	MEField *pLocationField;
	MEField *pMapField;
	MEField *pAlternateMapField;
...
typedef struct MDEMissionGroup
{
	...
	MDEDisplayOverrideGroup **eaDisplayOverrideGroups;
	...
	UIExpander *pDisplayOverrideExpander;
	...
	UIButton *pAddDisplayOverrideButton;
