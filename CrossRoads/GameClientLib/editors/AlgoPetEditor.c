...
static void ap_initColumns(METable *pTable)
{
	...
	METableAddSimpleColumn(pTable,  "Costume Slot Type", "SlotType", 100, AP_GROUP_MAIN, kMEFieldType_TextEntry);
}
...
static void ap_initUniformOverlayColumns(METable *pTable)
{
	...
	METableAddSimpleSubColumn(pTable,id,"Unlock","UnlockAll",100,"Uniform",kMEFieldType_BooleanCombo);
}
