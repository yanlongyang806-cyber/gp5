...
static void dte_rewardTypeChangeCallback(METable *pTable, DonationTaskDef *pDef, DonationTaskReward *pReward, void *pUserData, bool bInitNotify)
{
	...
	METableSetSubFieldNotApplicable(pTable, pDef, dteRewards, pReward, "Discount", (pReward->rewardType != DonationTaskRewardType_GuildProjectDiscount) && (pReward->rewardType != DonationTaskRewardType_PlayerProjectDiscount));
	METableSetSubFieldNotApplicable(pTable, pDef, dteRewards, pReward, "Bonus", (pReward->rewardType != DonationTaskRewardType_Bonus));
}
...
static void dte_startRewardTypeChangeCallback(METable *pTable, DonationTaskDef *pDef, DonationTaskReward *pReward, void *pUserData, bool bInitNotify)
{
	...
	METableSetSubFieldNotApplicable(pTable, pDef, dteStartRewards, pReward, "Discount", (pReward->rewardType != DonationTaskRewardType_GuildProjectDiscount) && (pReward->rewardType != DonationTaskRewardType_PlayerProjectDiscount));
	METableSetSubFieldNotApplicable(pTable, pDef, dteStartRewards, pReward, "Bonus", (pReward->rewardType != DonationTaskRewardType_Bonus));
}
...
static void dte_initDonationTaskColumns(METable *pTable)
{
	...
	if(gConf.bNoCostDonationTasksAllowed) {
		METableAddSimpleColumn(pTable, "No Cost", "noCost", 100, DTE_GROUP_MAIN, kMEFieldType_BooleanCombo);
	}
	...
	METableAddGlobalDictColumn(pTable, "Task Available Event", "activityEventRequirement", 180, DTE_GROUP_MAIN, kMEFieldType_Combo, "EventDef", "resourceName");
	METableAddEnumColumn(pTable, "Category", "category", 120, DTE_GROUP_MAIN, kMEFieldType_Combo, DonationTaskCategoryTypeEnum);
	METableAddGlobalDictColumn(pTable, "Player Finalize Reward Table", "finalizationRewardTable", 240, DTE_GROUP_MAIN, kMEFieldType_ValidatedTextEntry, "RewardTable", "resourceName");
	METableAddGlobalDictColumn(pTable, "Player Completion Reward Table", "completionRewardTable", 240, DTE_GROUP_MAIN, kMEFieldType_ValidatedTextEntry, "RewardTable", "resourceName");
...
static void dte_initRequirementColumns(METable *pTable)
{
	...
	METableAddGlobalDictSubColumn(pTable, id, "Applicable Discounts", "Discount", 240, DTE_SUBGROUP_REQUIRES, kMEFieldType_ValidatedTextEntry, g_DonationTaskDiscountDict, "resourceName");
...
static void dte_initRewardColumns(METable *pTable)
{
	...
	METableAddGlobalDictSubColumn(pTable, id, "Unlock", "Unlock", 240, DTE_SUBGROUP_REWARDS, kMEFieldType_ValidatedTextEntry, g_GroupProjectUnlockDict, "resourceName");
	METableAddGlobalDictSubColumn(pTable, id, "Project Numeric", "Numeric", 240, DTE_SUBGROUP_REWARDS, kMEFieldType_ValidatedTextEntry, g_GroupProjectNumericDict, "resourceName");
	METableAddSimpleSubColumn(pTable, id, "Reward Constant", "rewardConstant", 240, DTE_SUBGROUP_REWARDS, kMEFieldType_TextEntry);
	METableAddGlobalDictSubColumn(pTable, id, "Discount", "Discount", 240, DTE_SUBGROUP_REWARDS, kMEFieldType_TextEntry, g_DonationTaskDiscountDict, "resourceName");
	METableAddGlobalDictSubColumn(pTable, id, "Bonus", "Bonus", 240, DTE_SUBGROUP_REWARDS, kMEFieldType_TextEntry, g_GroupProjectBonusDict, "resourceName");
}
...
static void dte_initStartRewardColumns(METable *pTable)
{
    ...
    METableAddGlobalDictSubColumn(pTable, id, "Unlock", "Unlock", 240, DTE_SUBGROUP_STARTREWARDS, kMEFieldType_ValidatedTextEntry, g_GroupProjectUnlockDict, "resourceName");
    METableAddGlobalDictSubColumn(pTable, id, "Project Numeric", "Numeric", 240, DTE_SUBGROUP_STARTREWARDS, kMEFieldType_ValidatedTextEntry, g_GroupProjectNumericDict, "resourceName");
    METableAddSimpleSubColumn(pTable, id, "Reward Constant", "rewardConstant", 240, DTE_SUBGROUP_STARTREWARDS, kMEFieldType_TextEntry);
    METableAddGlobalDictSubColumn(pTable, id, "Discount", "Discount", 240, DTE_SUBGROUP_STARTREWARDS, kMEFieldType_TextEntry, g_DonationTaskDiscountDict, "resourceName");
    METableAddGlobalDictSubColumn(pTable, id, "Bonus", "Bonus", 240, DTE_SUBGROUP_STARTREWARDS, kMEFieldType_TextEntry, g_GroupProjectBonusDict, "resourceName");
}
...
static void dte_init(MultiEditEMDoc *pEditorDoc)
{
	if (!dteWindow) {
		...
		// Set edit mode
		resSubscribeToInfoIndex(g_GroupProjectUnlockDict, true);
		resSubscribeToInfoIndex(g_GroupProjectNumericDict, true);
		resSubscribeToInfoIndex(g_DonationTaskDiscountDict, true);
		resSubscribeToInfoIndex(g_GroupProjectBonusDict, true);
		resSubscribeToInfoIndex("RewardTable", true);
	}
