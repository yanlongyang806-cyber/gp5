...
void gclUGCPublishEnabled(bool bUGCPublishEnabled)
{
	UGCEditorDoUGCPublishEnabled(bUGCPublishEnabled);
}
...
AUTO_COMMAND ACMD_CLIENTCMD ACMD_ACCESSLEVEL(0) ACMD_PRIVATE;
void ugcEditorForceUpdateAutosave( Entity* pEntity )
{
	ugcEditorDoForceUpdateAutosave();
}
