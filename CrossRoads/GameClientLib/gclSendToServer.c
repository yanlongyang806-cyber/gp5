...
static bool sbDisableChat = false;
AUTO_CMD_INT(sbDisableChat, DisableChat) ACMD_CMDLINE;
...
static void gclChatRelayConnectCallback(NetLink* link,void *user_data)
{
	...
	{
		// Got connect callback when not expected; reset Chat Relay connection and reconnect
