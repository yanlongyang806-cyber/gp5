...
void initEntDebug(void)
{
	...
	s_DebugMenuState.menuItemNameTable = stashTableCreateWithStringKeys(100, StashDeepCopyKeys_NeverRelease | StashCaseSensitive);
}
