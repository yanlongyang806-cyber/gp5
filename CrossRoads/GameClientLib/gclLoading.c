...
static int loadEndThreshold = 10;
AUTO_CMD_INT(loadEndThreshold, loadEndThreshold);
...
{
	const char* serverName = ORGANIZATION_DOMAIN_GAMESERVER;
...
static void gclLoadingGameplay_BeginFrame(void)
{
	...
	if (!gfxLoadingIsStillLoadingEx(0.25f, 10, loadEndThreshold, true))
	{
