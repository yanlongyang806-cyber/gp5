...
void HeadShotForCostumesOnlyDone(HeadshotForCostumesOnly *pUserData)
{
	...
	if(pUserData->pFileName && !gNoUpload)
	{
		...
		pArgs = urlToUrlArgumentList(gUploadURL ? gUploadURL : "http://" ORGANIZATION_DOMAIN "/wgsGameImage/post"); // Use URL "http://jgalvin:85/wgsGameImage/post" for testing
								  ...
								  const char *framename)
{
	...
	pWLCostume = costumeGenerate_CreateWLCostume(pHandle->pPlayerCostume, pSpecies, NULL, NULL, NULL, NULL, NULL, NULL, NULL, "Saved.", 0, 0, true, &eaSubCostumes);
													 ...
													 const char *pcPose, bool bTransparent)
{
	...
	pWLCostume = costumeGenerate_CreateWLCostume((PlayerCostume *)pCostumeInfo->pPlayerCostume, NULL/*species*/, NULL, NULL, NULL, NULL, NULL, NULL, NULL, "View.", 0, 0, true, &eaSubCostumes);
