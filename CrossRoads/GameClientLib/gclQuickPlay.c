...
KeyBindProfile s_OverrideProfile = {"QuickPlay Overrides", __FILE__, KeyboardLocale_EnglishUS, NULL, true, true};
...
AUTO_STARTUP(QuickPlay) ASTRT_DEPS(AS_CharacterAttribs);
