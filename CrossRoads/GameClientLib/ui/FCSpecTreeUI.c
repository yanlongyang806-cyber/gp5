...
static void SpecTree_GetPowerListNodesEx(SA_PARAM_NN_VALID UIGen* pGen, SA_PARAM_OP_VALID Entity *pEnt, SA_PARAM_OP_VALID Entity *pFakeEnt, SA_PARAM_OP_VALID PowerTree *pTree, SA_PARAM_OP_VALID PowerTreeDef *pTreeDef, int iMax)
{
...
void SpecTree_GetPowerListNodesByTreeDef(SA_PARAM_NN_VALID UIGen* pGen, SA_PARAM_OP_VALID Entity *pEnt, SA_PARAM_OP_VALID Entity *pFakeEnt, SA_PARAM_OP_VALID PowerTreeDef *pTreeDef, int iMax)
{
...
void SpecTree_GetPowerListNodesByTree(SA_PARAM_NN_VALID UIGen* pGen, SA_PARAM_OP_VALID Entity *pEnt, SA_PARAM_OP_VALID Entity *pFakeEnt,  SA_PARAM_OP_VALID PowerTree *pTree, int iMax)
{
