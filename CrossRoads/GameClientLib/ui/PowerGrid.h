...
typedef struct PowerListNode
{
	...
	// If true, this node is a conditional node
	U32 bIsConditionalNode : 1;

	// if true, this node can be accessed. 
	U32 bCanAccessConditionalNode : 1;
	...
	// True if the player entity isn't the same as the fake entity
	U32 bIsFakeEntDifferent : 1;
