...
void ctm_IssueCommandButtonDown(bool bActive)
{
	...
	U32 ppowID = 0;
	Vec3 worldPos;
	Entity* pTarget = target_SelectUnderMouse(e, kTargetType_Alive,kTargetType_Self, worldPos, true, true, false, false);
...
void ctm_UnifiedButtonDoubleclick()
{
	...
	TrayElem* pelem = NULL;
	Power *ppow = NULL;
	Entity* pTarget = target_SelectUnderMouse(e, kTargetType_Alive,kTargetType_Self, NULL, true, true, false, false);
