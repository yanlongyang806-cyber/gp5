...
AUTO_TRANS_HELPER
ATR_LOCKS(pEnt, ".Pplayer.Eskillspecialization, .Pchar.Ppsecondarypaths, .Pchar.Hpath, .Pplayer.Skilltype, .Psaved.Pscpdata, .Pinventoryv1_Deprecated, .Pplayer.Pemailv1_Deprecated, .Pplayer.pEmailV2, .Psaved.Ufixupversion, .Pchar.Hclass, .Pchar.Ilevelexp, .Psaved.Ppbuilds, .Pinventoryv2, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Psaved.Conowner.Containerid, .Psaved.Conowner.Containertype, .Hallegiance, .Hsuballegiance, .Itemidmax, .Pchar.Uipoweridmax, .Psaved.Ipetid, .Psaved.Ppuppetmaster.Curid, .Psaved.Ppuppetmaster.Curtype, .Psaved.Ppownedcontainers, .Psaved.Ppuppetmaster.Curtempid, .Psaved.Ppallowedcritterpets, .Psaved.Costumedata.Eaunlockedcostumerefs, .Pplayer.Pplayeraccountdata.Eapendingkeys, .Psaved.Uiindexbuild, .Pplayer.Playertype, .Pplayer.Eaplayernumericthresholds, .Pplayer.Eaastrrecentlyacquiredstickerbookitems");
...
AUTO_TRANSACTION
ATR_LOCKS(pEnt, ".Pplayer.Eskillspecialization, .Pchar.Ppsecondarypaths, .Pchar.Hpath, .Pplayer.Skilltype, .Psaved.Pscpdata, .Psaved.Ufixupversion, .Psaved.Obsolete_Costumedata, .Psaved.Costumedata, .Pinventoryv1_Deprecated, .Pplayer.Pemailv1_Deprecated, .Pplayer.pEmailV2, .Pchar.Hclass, .Pchar.Ilevelexp, .Psaved.Ppbuilds, .Pinventoryv2, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Psaved.Conowner.Containerid, .Psaved.Conowner.Containertype, .Hallegiance, .Hsuballegiance, .Itemidmax, .Pchar.Uipoweridmax, .Psaved.Ipetid, .Psaved.Ppuppetmaster.Curid, .Psaved.Ppuppetmaster.Curtype, .Psaved.Ppownedcontainers, .Psaved.Ppuppetmaster.Curtempid, .Psaved.Ppallowedcritterpets, .Pplayer.Pplayeraccountdata.Eapendingkeys, .Psaved.Uiindexbuild, .Pplayer.Playertype, .Pplayer.Eaplayernumericthresholds, .Pplayer.Eaastrrecentlyacquiredstickerbookitems");
