...
void aslLogin2_GetCharacterChoicesCmd(SlowRemoteCommandID commandID, ContainerID accountID, bool forcePopulateDeletedChoiceLists)
{
    if ( accountID )
    {
        aslLogin2_GetCharacterChoices(accountID, GetCharacterChoicesCmdCB, (void *)((intptr_t)commandID), forcePopulateDeletedChoiceLists);
    }
    else
    {
