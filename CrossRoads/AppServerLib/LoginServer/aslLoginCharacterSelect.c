...
static bool sbEveryoneCanAccessAllVShards = true;
...
//if true, then characters can edit UGC if they are on the UGC virtual shard
...
// default extra shared bank data
void DEFAULT_LATELINK_gameSpecific_EntitySharedBankExtraData(NOCONST(Entity) *pSharedBank)
{
}
