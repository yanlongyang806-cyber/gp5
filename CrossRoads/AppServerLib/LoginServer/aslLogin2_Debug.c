...
{
    aslLogin2_GetCharacterChoices(accountID, DebugGetCharacterChoicesCB, NULL, false);
}
...
AUTO_COMMAND ACMD_CATEGORY(Debug);
void
aslLogin2_Debug_GetCharacterDetail(U32 accountID, U32 playerID, const char *shardName, bool returnActivePuppets, bool returnTeamRequestPets, bool fixupRequired)
{
    aslLogin2_GetCharacterDetail(accountID, playerID, shardName, returnActivePuppets, returnTeamRequestPets, fixupRequired, DebugGetCharacterDetailCB, NULL);
}