...
AUTO_STRUCT;
typedef struct GADPurchasePacketData
{
	ContainerID characterID;		// character making the purchase
	const char *purchaseDefName;		// The purchase def (GameAccountDataNumericPurchaseDef)
...
void aslLogin2_SendSupportedLanguages(Login2State*loginState);
