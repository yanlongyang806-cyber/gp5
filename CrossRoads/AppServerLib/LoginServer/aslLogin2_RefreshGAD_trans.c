...
aslLogin2_tr_RefreshGAD(ATR_ARGS, NOCONST(GameAccountData) *pAccountData, ParsedAVPList *pAttribList, NON_CONTAINER GamePermissionDefs *pTempPermissions,
    S32 bLifetime, S32 bPress, AccountProxyAccountDataResponse *accountServerData, PooledStringArrayStruct *gamePermissionsFromAccountPermissions, U32 overrideLevel, U32 refreshTime)
{
    U32 daysSubscribed;
    int index;

    pAccountData->uLastRefreshTime = refreshTime;
