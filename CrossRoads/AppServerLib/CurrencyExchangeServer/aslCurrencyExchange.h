...
void aslCurrencyExchange_WithdrawOrder(U32 uGatewayServerID, ContainerID accountID, ContainerID characterID, const char *charName, U32 orderID, const char *debugName, const char *gameSpecificLogInfo);
