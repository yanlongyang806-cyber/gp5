...
void
aslCurrencyExchange_CreateOrderEx(U32 uGatewayServerID, ContainerID accountID, ContainerID characterID, const char *charName, CurrencyExchangeOrderType orderType, U32 quantity, U32 price, const char *debugName, const char *gameSpecificLogInfo, bool skipQuantityCheck)
{
	...
	operation->uNotifyGatewayServerID = uGatewayServerID;
...
void
aslCurrencyExchange_CreateOrder(U32 uGatewayServerID, ContainerID accountID, ContainerID characterID, const char *charName, CurrencyExchangeOrderType orderType, U32 quantity, U32 price, const char *debugName, const char *gameSpecificLogInfo)
{
    aslCurrencyExchange_CreateOrderEx(uGatewayServerID, accountID, characterID, charName, orderType, quantity, price, debugName, gameSpecificLogInfo, false);
}
...
{
    aslCurrencyExchange_CreateOrderEx(0, accountID, characterID, charName, OrderType_Sell, quantity, price, debugName, "", true);
}
...
{
    aslCurrencyExchange_CreateOrderEx(0, accountID, characterID, charName, OrderType_Buy, quantity, price, debugName, "", true);
}

AUTO_COMMAND_REMOTE ACMD_IFDEF(GAMESERVER) ACMD_CATEGORY(CurrencyExchange);
void
aslCurrencyExchange_WithdrawOrder(U32 uGatewayServerID, ContainerID accountID, ContainerID characterID, const char *charName, U32 orderID, const char *debugName, const char *gameSpecificLogInfo)
{
...
AUTO_COMMAND_REMOTE ACMD_IFDEF(GAMESERVER) ACMD_CATEGORY(CurrencyExchange);
void
aslCurrencyExchange_ClaimMTC(U32 uGatewayServerID, ContainerID accountID, ContainerID characterID, const char *charName, U32 quantity, const char *debugName, const char *gameSpecificLogInfo)
{
...
AUTO_COMMAND_REMOTE ACMD_IFDEF(GAMESERVER) ACMD_CATEGORY(CurrencyExchange);
void
aslCurrencyExchange_ClaimTC(U32 uGatewayServerID, ContainerID accountID, ContainerID characterID, const char *charName, U32 quantity, const char *debugName, const char *gameSpecificLogInfo)
{
