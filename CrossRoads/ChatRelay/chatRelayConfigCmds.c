...
// Sets whether chat log entries should show the channel names
AUTO_COMMAND ACMD_GENERICSERVERCMD ACMD_ACCESSLEVEL(0) ACMD_PRIVATE;
void crChatConfig_SetStickyChannels(GenericServerCmdData *pCmdData, bool bStickyChannels) 
{
	CMDDATA_TO_RELAYUSER;
	AutoTrans_tr_crChatConfig_SetStickyChannels(NULL, GLOBALTYPE_CHATRELAY, GLOBALTYPE_GAMEACCOUNTDATA, relayUser->uAccountID, bStickyChannels);
}
