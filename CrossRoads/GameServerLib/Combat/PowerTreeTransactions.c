...
AUTO_TRANSACTION
ATR_LOCKS(pEnt, ".Psaved.pSCPdata.Isummonedscp, .Psaved.pSCPdata.Fcachedpetbonusxppct, .Psaved.pSCPdata.erSCP, .Pinventoryv2.Ppinventorybags[], .Pchar.Uipowertreemodcount, .Pchar.Pppowertrees, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Pchar.Uipoweridmax, .Psaved.Ipetid, .Psaved.Ppuppetmaster.Curid, .Psaved.Ppuppetmaster.Curtype, .Psaved.Ppownedcontainers, .Psaved.Ppuppetmaster.Curtempid, .Psaved.Ppallowedcritterpets, .Hallegiance, .Hsuballegiance, .Pchar.Ilevelexp, pInventoryV2.ppLiteBags[], .Pplayer.Eaplayernumericthresholds")
ATR_LOCKS(pPayer, ".Psaved.pSCPdata.Isummonedscp, .Psaved.pSCPdata.Fcachedpetbonusxppct, .Psaved.pSCPdata.erSCP, .Pinventoryv2.Ppinventorybags[], .Hallegiance, .Hsuballegiance, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Pchar.Ilevelexp, pInventoryV2.ppLiteBags[], .Pplayer.Eaplayernumericthresholds");
...
AUTO_TRANSACTION
ATR_LOCKS(pEnt, ".Psaved.pSCPdata.Isummonedscp, .Psaved.pSCPdata.Fcachedpetbonusxppct, .Psaved.pSCPdata.erSCP, .Pinventoryv2.Ppinventorybags[], .Pchar.Uipowertreemodcount, .Pchar.Uilastfreerespectime, .Pchar.Uilastforcedrespectime, .Pplayer.Icreatedtime, .Pchar.Pppowertrees, .Hallegiance, .Hsuballegiance, .Psaved.Ppuppetmaster.Curtempid, .Psaved.Ppallowedcritterpets, .Pchar.Pppointspentpowertrees, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Pchar.Ilevelexp, .Pchar.Uipoweridmax, .Psaved.Ipetid, .Psaved.Ppuppetmaster.Curid, .Psaved.Ppuppetmaster.Curtype, .Psaved.Ppownedcontainers, pInventoryV2.ppLiteBags[], .Pplayer.Eaplayernumericthresholds")
...
void entity_PowerTreeAutoBuyEx(int iPartitionIdx, Entity *pEnt, Entity *pPayer, bool bFullRespec)
{
	if(pEnt && pEnt->pChar)
	{
		...
		// we can't pass in payer being the same entity 
		// due to transactions not handling passing in the same container to a transaction twice
		// the code will just use pEnt as the payer
		if (pEnt == pPayer)
			pPayer = NULL;
								 ...
								 S32 bStepRespec)
{
	if(pEnt && pEnt->pChar && pStepsRequestedRespec)
	{
		...
		if(entity_PowerTreeStepsRespecSteps(iPartitionIdx,pEnt,NULL,pStepsRequestedRespec,pStepsRequestedBuy,pStepsResultRespec,pStepsResultBuy,eRespecType,false,bStepRespec))
		{
			ItemChangeReason reason = {0};
...
AUTO_TRANSACTION ATR_LOCKS(pEnt, ".Psaved.pSCPdata.Isummonedscp, .Psaved.pSCPdata.Fcachedpetbonusxppct, .Psaved.pSCPdata.erSCP, .Pinventoryv2.Ppinventorybags[], .Pchar.Pppowertrees, .Hallegiance, .Hsuballegiance, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Pchar.Ilevelexp, pInventoryV2.ppLiteBags[], .Pplayer.Eaplayernumericthresholds");
...
AUTO_TRANSACTION
	ATR_LOCKS(pEnt, ".Psaved.pSCPdata.Isummonedscp, .Psaved.pSCPdata.Fcachedpetbonusxppct, .Psaved.pSCPdata.erSCP, .pInventoryV2.ppInventoryBags[], .Psaved.Ppuppetmaster.Curtempid, .Pchar.Uipowertreemodcount, .Pchar.Uilastfreerespectime, .Pchar.Uilastforcedrespectime, .Pplayer.Icreatedtime, .Pchar.Pppowertrees, .Psaved.Ppallowedcritterpets, .Pchar.Pppointspentpowertrees, .Hallegiance, .Hsuballegiance, .Pchar.Ilevelexp, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Pchar.Uipoweridmax, .Psaved.Ipetid, .Psaved.Ppuppetmaster.Curid, .Psaved.Ppuppetmaster.Curtype, .Psaved.Ppownedcontainers, pInventoryV2.ppLiteBags[], .Pplayer.Eaplayernumericthresholds")
	ATR_LOCKS(pPayer, ".Psaved.pSCPdata.Isummonedscp, .Psaved.pSCPdata.Fcachedpetbonusxppct, .Psaved.pSCPdata.erSCP, .pInventoryV2.ppInventoryBags[], .Pchar.Ilevelexp, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Hallegiance, .Hsuballegiance, pInventoryV2.ppLiteBags[], .Pplayer.Eaplayernumericthresholds");
								   ...
								   const ItemChangeReason *pReason, GameAccountDataExtract *pExtract)
{
	...
	if (uiRemoveItemID)
	{
		...
		if (inv_trh_FindItemByID(ATR_PASS_ARGS, pBuyer, uiRemoveItemID, pIter))
		...
		if (ISNULL(pItem) || !invbag_RemoveItem(ATR_PASS_ARGS, pBuyer, false, bagiterator_GetCurrentBagID(pIter), pIter->i_cur, 1, false, pReason, pExtract))
		{
								...
								GameAccountDataExtract *pBuyerExtract)
{
	...
	{
		BagIterator* pIter = bagiterator_Create();
		if (inv_trh_FindItemByID(ATR_PASS_ARGS, pBuyer, uiItemID, pIter))
			pItem = inv_bag_trh_GetItem(ATR_PASS_ARGS, bagiterator_GetCurrentBag(pIter), pIter->i_cur);
		bagiterator_Destroy(pIter);
...
AUTO_TRANSACTION
ATR_LOCKS(pBuyer, ".Pplayer.Eaplayernumericthresholds, .Psaved.Pscpdata.Isummonedscp, .Psaved.Pscpdata.Fcachedpetbonusxppct, .Psaved.Pscpdata.Erscp, .pInventoryV2.Peaowneduniqueitems, pInventoryV2.ppLiteBags, .pInventoryV2.Ppinventorybags, .Psaved.Conowner.Containertype, .Hallegiance, .Hsuballegiance, .Pchar.Ilevelexp, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Psaved.Uiindexbuild, .Psaved.Ppbuilds, .Psaved.Conowner.Containerid")
ATR_LOCKS(pEnt, ".Psaved.pSCPdata.Isummonedscp, .Psaved.pSCPdata.Fcachedpetbonusxppct, .Psaved.pSCPdata.erSCP, .Pinventoryv2.Ppinventorybags[], .Pchar.Pptraining, .Psaved.Ppuppetmaster.Curtempid, .Pchar.Uipowertreemodcount, .Pchar.Uilastfreerespectime, .Pchar.Uilastforcedrespectime, .Pplayer.Icreatedtime, .Pchar.Pppowertrees, .Hallegiance, .Hsuballegiance, .Psaved.Ppallowedcritterpets, .Pchar.Pppointspentpowertrees, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Pchar.Ilevelexp, .Pchar.Uipoweridmax, .Psaved.Ipetid, .Psaved.Ppuppetmaster.Curid, .Psaved.Ppuppetmaster.Curtype, .Psaved.Ppownedcontainers, pInventoryV2.ppLiteBags[], .Pplayer.Eaplayernumericthresholds");
...
AUTO_TRANSACTION
ATR_LOCKS(pBuyer, ".Psaved.pSCPdata.Isummonedscp, .Psaved.pSCPdata.Fcachedpetbonusxppct, .Psaved.pSCPdata.erSCP, .pInventoryV2.Ppinventorybags, .Hallegiance, .Hsuballegiance, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Pchar.Ilevelexp, pInventoryV2.ppLiteBags[], .Pplayer.Eaplayernumericthresholds")
												  ...
												  const char* pchNewNodeDef, const ItemChangeReason *pReason)
{
	...
	for (i = eaSize(&pEnt->pChar->ppTraining)-1; i >= 0; i--)
	{
		...
		if (stricmp(pchNewNodeDef,REF_STRING_FROM_HANDLE(pTraining->hNewNodeDef))==0)
		{
			...
			inv_trh_FindItemByID(ATR_PASS_ARGS, pBuyer, pTraining->uiItemID, pIter);
	...
	switch (pTraining->eType)
	{
		xcase CharacterTrainingType_Give:
		{
			...
			if (pchTree && pTraining->iNewNodeRank > iNodeRank)
			{
				...
				if (entity_PowerTreeStepsRespecSteps(iPartitionIdx,pEnt,pOwner,pCheckStepsRespec,pCheckStepsBuy,pStepsRespec,pStepsBuy,kPTRespecGroup_ALL,false,false))
				{
					bSuccess = true;
				}
