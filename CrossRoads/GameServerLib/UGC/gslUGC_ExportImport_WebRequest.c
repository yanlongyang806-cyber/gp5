...
{
	UGCProjectContainerAndDataForImport *pUGCProjectContainerAndDataForImport = NULL;

	pUGCProjectContainerAndDataForImport = StructCreate(parse_UGCProjectContainerAndDataForImport);
	...
	if(!nullStr(strUGCProjectDataPublished))
	{
	...
	if(!nullStr(strUGCProjectDataSaved))
	{
		char *estrNewNotes = NULL;
		UGCProjectDataHeader *pUGCProjectDataHeader = NULL;
