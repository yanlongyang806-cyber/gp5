...
AUTO_TRANSACTION
ATR_LOCKS(pOwner, ".Psaved.pSCPdata.Isummonedscp, .Psaved.pSCPdata.Fcachedpetbonusxppct, .Psaved.pSCPdata.erSCP, .Pinventoryv2.Ppinventorybags[], .Hallegiance, .Hsuballegiance, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Pchar.Ilevelexp, pInventoryV2.ppLiteBags[], .Pplayer.Eaplayernumericthresholds")
ATR_LOCKS(pOfficer, ".Psaved.pSCPdata.Isummonedscp, .Psaved.pSCPdata.Fcachedpetbonusxppct, .Psaved.pSCPdata.erSCP, .Pinventoryv2.Ppinventorybags[], .Hallegiance, .Hsuballegiance, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Pchar.Ilevelexp, pInventoryV2.ppLiteBags[], .Pplayer.Eaplayernumericthresholds");
...
void gslTrainOfficer( Entity* pPlayerEnt, S32 iTrainerType, U32 iTrainerID, U32 uiOfficerID, const char* pchOldNode, const char* pchNewNode )
{
	...
	if (	pEnt==NULL || pNewNodeDef==NULL
		|| !Officer_CanTrain( iPartitionIdx, pPlayerEnt, pEnt, uiOfficerID, pchOldNode, pchNewNode, true, true, pPreferredAllegiance, &pTrainNodeDef ) 
	...
	character_StartTraining(iPartitionIdx,pPlayerEnt, pOfficer,
							pchOldNode, pTrainNodeDef->pchNameFull, 0, pDef->pchTrainingNumeric, pDef->iTrainingCost, 
