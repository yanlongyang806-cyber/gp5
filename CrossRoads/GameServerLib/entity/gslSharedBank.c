...
AUTO_TRANSACTION
	ATR_LOCKS(pSharedBank, ".Psaved.Pscpdata, .Psaved.Ppbuilds, .Psaved.Conowner.Containerid, .Pinventoryv2, .Hallegiance, .Hsuballegiance, .Psaved.Conowner.Containertype,\
						   ...
						   .Psaved.Costumedata.Eaunlockedcostumerefs, .Pplayer.Pplayeraccountdata.Eapendingkeys, .Psaved.Uiindexbuild, .Pchar.Ilevelexp, .Pplayer.Playertype,\
						   .Pplayer.Eaplayernumericthresholds, .Pchar.Hclass, .Pchar.Ppsecondarypaths, .Pchar.Hpath, .Pplayer.Skilltype, .Pplayer.Eskillspecialization, .Pplayer.Eaastrrecentlyacquiredstickerbookitems");
...
AUTO_TRANSACTION
	ATR_LOCKS(pEnt, ".Psaved.pSCPdata.Isummonedscp, .Psaved.pSCPdata.Fcachedpetbonusxppct, .Psaved.pSCPdata.erSCP, .pInventoryV2.ppInventoryBags[], .Pchar.Ilevelexp, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Hallegiance, .Hsuballegiance, pInventoryV2.ppLiteBags[], .Pplayer.Eaplayernumericthresholds")
	ATR_LOCKS(pSharedBankEnt, ".Psaved.pSCPdata.Isummonedscp, .Psaved.pSCPdata.Fcachedpetbonusxppct, .Psaved.pSCPdata.erSCP, .pInventoryV2.ppInventoryBags[], .Pchar.Ilevelexp, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Hallegiance, .Hsuballegiance, pInventoryV2.ppLiteBags[], .Pplayer.Eaplayernumericthresholds");
