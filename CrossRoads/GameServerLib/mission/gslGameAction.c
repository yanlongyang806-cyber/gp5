...
AUTO_TRANSACTION
	ATR_LOCKS(ent, ".Pplayer.Pemailv2.Unextfuturedelivery, .Pplayer.Pemailv2.Bunreadmail, .Pplayer.Skilltype, .Pplayer.Eskillspecialization, .Pchar.Hclass, .Pchar.Ppsecondarypaths, .Pchar.Hpath, .Psaved.pSCPdata.Isummonedscp, .Psaved.pSCPdata.Fcachedpetbonusxppct, .Psaved.pSCPdata.erSCP, .Psaved.pSCPdata.Isummonedscp, .Psaved.pSCPdata.Fcachedpetbonusxppct, .Pplayer.Pplayeraccountdata.Eapendingkeys, .Psaved.Nextactivitylogid, .Hallegiance, .Hsuballegiance, .Pchar.Ilevelexp, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Psaved.Activitylogentries[AO], .Psaved.Uiindexbuild, .Psaved.Ppbuilds, .Psaved.Conowner.Containerid, .Psaved.Conowner.Containertype, .Pinventoryv2.Peaowneduniqueitems, .Pinventoryv2.Ppinventorybags, .Pinventoryv2.Pplitebags, .Pplayer.Playertype, .Psaved.Ppownedcontainers, .Itemidmax, .Pchar.Uipoweridmax, .Psaved.Ipetid, .Psaved.Ppuppetmaster.Curid, .Psaved.Ppuppetmaster.Curtype, .Psaved.Ppuppetmaster.Curtempid, .Psaved.Ppallowedcritterpets, .Pplayer.Missioninfo.Missions, .Pplayer.Missioninfo.Completedmissions, .Pplayer.Missioninfo.Eamissionrequests, .Pplayer.Missioninfo.Eamissioncooldowns, .Pplayer.Nemesisinfo.Eanemesisstates, .Pplayer.pEmailV2.Ilastusedid, .Pplayer.Langid, .Pplayer.pEmailV2.Mail, .Pplayer.Eaplayernumericthresholds, .Pplayer.Eaastrrecentlyacquiredstickerbookitems")
...
AUTO_TRANS_HELPER	
	ATR_LOCKS(ent, ".Pplayer.Pemailv2.Unextfuturedelivery, .Pplayer.Pemailv2.Bunreadmail, .Pplayer.Skilltype, .Pplayer.Eskillspecialization, .Pchar.Hclass, .Pchar.Ppsecondarypaths, .Pchar.Hpath, .Psaved.pSCPdata.Isummonedscp, .Psaved.pSCPdata.Fcachedpetbonusxppct, .Psaved.pSCPdata.erSCP, .Pplayer.Pplayeraccountdata.Eapendingkeys, .Psaved.Nextactivitylogid, .Hallegiance, .Hsuballegiance, .Pchar.Ilevelexp, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Psaved.Activitylogentries[AO], .Psaved.Uiindexbuild, .Psaved.Ppbuilds, .Psaved.Conowner.Containerid, .Psaved.Conowner.Containertype, .Pinventoryv2.Peaowneduniqueitems, .Pinventoryv2.Ppinventorybags, .Pinventoryv2.Pplitebags, .Pplayer.Playertype, .Psaved.Ppownedcontainers, .Itemidmax, .Pchar.Uipoweridmax, .Psaved.Ipetid, .Psaved.Ppuppetmaster.Curid, .Psaved.Ppuppetmaster.Curtype, .Psaved.Ppuppetmaster.Curtempid, .Psaved.Ppallowedcritterpets, .Pplayer.Missioninfo.Missions, .Pplayer.Missioninfo.Completedmissions, .Pplayer.Missioninfo.Eamissionrequests, .Pplayer.Missioninfo.Eamissioncooldowns, .Pplayer.Nemesisinfo.Eanemesisstates, .Pplayer.pEmailV2.Ilastusedid, .Pplayer.Langid, .Pplayer.pEmailV2.Mail, .Pplayer.Eaplayernumericthresholds, .Pplayer.Eaastrrecentlyacquiredstickerbookitems")
	ATR_LOCKS(eaVarContainer, ".id, .Uclock, .Eaworldvars")
	ATR_LOCKS(pGuild, ".Inextactivitylogentryid, .Eaactivityentries, .Eamembers, .Pguildstatsinfo, .Htheme");
...
{
	CONST_EARRAY_OF(WorldGameActionProperties)* actions = &pActionBlock->eaActions;
...
AUTO_TRANSACTION
ATR_LOCKS(ent, ".Pplayer.Pemailv2.Unextfuturedelivery, .Pplayer.Pemailv2.Bunreadmail, .Pplayer.Nemesisinfo.Eanemesisstates, .Pplayer.pEmailV2.Ilastusedid, .Pplayer.Langid, .Hallegiance, .Hsuballegiance, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Pplayer.pEmailV2.Mail, .Pchar.Ilevelexp");
...
AUTO_TRANSACTION
ATR_LOCKS(ent, ".Pplayer.Pemailv2.Unextfuturedelivery, .Pplayer.Pemailv2.Bunreadmail, .Pplayer.Skilltype, .Pplayer.Eskillspecialization, .Pchar.Hclass, .Pchar.Ppsecondarypaths, .Pchar.Hpath, .Psaved.pSCPdata.Isummonedscp, .Psaved.pSCPdata.Fcachedpetbonusxppct, .Psaved.pSCPdata.erSCP, .pInventoryV2.Peaowneduniqueitems, .pInventoryV2.Pplitebags, .Hallegiance, .Hsuballegiance, .Pplayer.pEmailV2.Ilastusedid, .Pplayer.Langid, .Pplayer.pEmailV2.Mail, .Itemidmax, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Pchar.Ilevelexp, .pInventoryV2.Ppinventorybags, .Psaved.Conowner.Containerid, .Psaved.Conowner.Containertype, .Psaved.Uiindexbuild, .Psaved.Ppbuilds, .Psaved.Ppownedcontainers, .Pchar.Uipoweridmax, .Psaved.Ipetid, .Psaved.Ppuppetmaster.Curid, .Psaved.Ppuppetmaster.Curtype, .Psaved.Ppuppetmaster.Curtempid, .Psaved.Ppallowedcritterpets, .Pplayer.Nemesisinfo.Eanemesisstates, .Pplayer.Playertype, .Pplayer.Eaplayernumericthresholds, .Pplayer.Eaastrrecentlyacquiredstickerbookitems");
...
AUTO_TRANSACTION
ATR_LOCKS(ent, ".Pplayer.Pemailv2.Unextfuturedelivery, .Pplayer.Pemailv2.Bunreadmail, .Pplayer.Skilltype, .Pplayer.Eskillspecialization, .Pchar.Hclass, .Pchar.Ppsecondarypaths, .Pchar.Hpath, .Psaved.pSCPdata.Isummonedscp, .Psaved.pSCPdata.Fcachedpetbonusxppct, .Psaved.pSCPdata.erSCP, .pInventoryV2.Peaowneduniqueitems, .pInventoryV2.Pplitebags, .Hallegiance, .Hsuballegiance, .Pplayer.pEmailV2.Ilastusedid, .Pplayer.Langid, .Pplayer.pEmailV2.Mail, .Itemidmax, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Pchar.Ilevelexp, .pInventoryV2.Ppinventorybags, .Psaved.Conowner.Containerid, .Psaved.Conowner.Containertype, .Psaved.Uiindexbuild, .Psaved.Ppbuilds, .Psaved.Ppownedcontainers, .Pchar.Uipoweridmax, .Psaved.Ipetid, .Psaved.Ppuppetmaster.Curid, .Psaved.Ppuppetmaster.Curtype, .Psaved.Ppuppetmaster.Curtempid, .Psaved.Ppallowedcritterpets, .Pplayer.Playertype, .Pplayer.Eaplayernumericthresholds, .Pplayer.Eaastrrecentlyacquiredstickerbookitems");
...
AUTO_TRANSACTION
ATR_LOCKS(ent, ".Pplayer.Pemailv2.Unextfuturedelivery, .Pplayer.Pemailv2.Bunreadmail, .Pplayer.Skilltype, .Pplayer.Eskillspecialization, .Pchar.Hclass, .Pchar.Ppsecondarypaths, .Pchar.Hpath, .Psaved.pSCPdata.Isummonedscp, .Psaved.pSCPdata.Fcachedpetbonusxppct, .Psaved.pSCPdata.erSCP, .Pplayer.pEmailV2.Ilastusedid, .Pplayer.Langid, .Hallegiance, .Hsuballegiance, .Pchar.Ilevelexp, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Pplayer.pEmailV2.Mail, .Psaved.Uiindexbuild, .Psaved.Ppbuilds, .Psaved.Conowner.Containerid, .Psaved.Conowner.Containertype, .Pinventoryv2.Peaowneduniqueitems, .Pinventoryv2.Ppinventorybags, .Pinventoryv2.Pplitebags, .Pplayer.Playertype, .Psaved.Ppownedcontainers, .Itemidmax, .Pchar.Uipoweridmax, .Psaved.Ipetid, .Psaved.Ppuppetmaster.Curid, .Psaved.Ppuppetmaster.Curtype, .Psaved.Ppuppetmaster.Curtempid, .Psaved.Ppallowedcritterpets, .Pplayer.Eaplayernumericthresholds, .Pplayer.Eaastrrecentlyacquiredstickerbookitems");
...
// Only locks NPCEMail
AUTO_TRANSACTION
ATR_LOCKS(ent, ".Pplayer.Pemailv2.Unextfuturedelivery, .Pplayer.Pemailv2.Bunreadmail, .Pplayer.pEmailV2.Ilastusedid, .Pplayer.Langid, .Hallegiance, .Hsuballegiance, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Pplayer.pEmailV2.Mail, .Pchar.Ilevelexp");
...
// Doesn't lock the player's inventory or nemeses
AUTO_TRANSACTION
	ATR_LOCKS(ent, ".Pplayer.Pemailv2.Unextfuturedelivery, .Pplayer.Pemailv2.Bunreadmail, .Pplayer.Nemesisinfo.Eanemesisstates, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Pplayer.pEmailV2.Mail, .Pplayer.pEmailV2.Ilastusedid, .Pplayer.Langid, .Hallegiance, .Hsuballegiance, .Pchar.Ilevelexp");
...
AUTO_TRANS_HELPER
	ATR_LOCKS(ent, ".Pplayer.Pemailv2.Unextfuturedelivery, .Pplayer.Pemailv2.Bunreadmail, .Pplayer.Skilltype, .Pplayer.Eskillspecialization, .Psaved.pSCPdata.Isummonedscp, .Psaved.pSCPdata.Fcachedpetbonusxppct, .Psaved.pSCPdata.erSCP, .Pchar.Ppsecondarypaths, .Pplayer.pEmailV2.Mail, .Psaved.Nextactivitylogid, .Hallegiance, .Hsuballegiance, .Pchar.Ilevelexp, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Psaved.Activitylogentries[AO], .Psaved.Uiindexbuild, .Psaved.Ppbuilds, .Psaved.Conowner.Containerid, .Psaved.Conowner.Containertype, .Pinventoryv2.Peaowneduniqueitems, .Pinventoryv2.Ppinventorybags, .Pinventoryv2.Pplitebags, .Pplayer.Playertype, .Psaved.Ppownedcontainers, .Itemidmax, .Pchar.Uipoweridmax, .Psaved.Ipetid, .Psaved.Ppuppetmaster.Curid, .Psaved.Ppuppetmaster.Curtype, .Psaved.Ppuppetmaster.Curtempid, .Psaved.Ppallowedcritterpets, .Pplayer.Missioninfo.Unextrequestid, .Pplayer.Missioninfo.Completedmissions, .Pplayer.Earewardmods, .Pteam.Lastrecruittype, .Psaved.Costumedata.Eaunlockedcostumerefs, .Pplayer.Pplayeraccountdata.Eapendingkeys, .Pplayer.Missioninfo.Missions, .Pplayer.Missioninfo.Eamissionrequests, .Pplayer.Missioninfo.Eamissioncooldowns, .Pplayer.Nemesisinfo.Eanemesisstates, .Pplayer.pEmailV2.Ilastusedid, .Pplayer.Langid, .Egender, .Pchar.Hclass, .Pchar.Hpath, .Pchar.Hspecies, .Pplayer.eaRewardGatedData, .Pplayer.Eaplayernumericthresholds, .Pplayer.Eaastrrecentlyacquiredstickerbookitems")
	ATR_LOCKS(eaVarContainer, ".id, .Uclock, .Eaworldvars")
	ATR_LOCKS(pGuild, ".Inextactivitylogentryid, .Eaactivityentries, .Eamembers, .Pguildstatsinfo, .Htheme")
	ATR_LOCKS(pMission, ".*");
...
AUTO_TRANS_HELPER
	ATR_LOCKS(ent, ".Pplayer.Pemailv2.Unextfuturedelivery, .Pplayer.Pemailv2.Bunreadmail, .Pplayer.Skilltype, .Pplayer.Eskillspecialization, .Psaved.pSCPdata.Isummonedscp, .Psaved.pSCPdata.Fcachedpetbonusxppct, .Psaved.pSCPdata.erSCP, .Pchar.Ppsecondarypaths, .Egender, .Pchar.Hclass, .Pchar.Hpath, .Pchar.Hspecies, .Pplayer.Missioninfo.Unextrequestid, .Pplayer.Missioninfo.Completedmissions, .Pplayer.Missioninfo.Missions, .Pplayer.Missioninfo.Eamissionrequests, .Pplayer.Missioninfo.Eamissioncooldowns, .Hallegiance, .Hsuballegiance, .Pplayer.pEmailV2.Mail, .Psaved.Nextactivitylogid, .Psaved.Activitylogentries[AO], .Itemidmax, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Pchar.Ilevelexp, .Pinventoryv2.Peaowneduniqueitems, .Pinventoryv2.Ppinventorybags, .Pinventoryv2.Pplitebags, .Psaved.Conowner.Containerid, .Psaved.Conowner.Containertype, .Psaved.Uiindexbuild, .Psaved.Ppbuilds, .Psaved.Ppownedcontainers, .Pchar.Uipoweridmax, .Psaved.Ipetid, .Psaved.Ppuppetmaster.Curid, .Psaved.Ppuppetmaster.Curtype, .Psaved.Ppuppetmaster.Curtempid, .Psaved.Ppallowedcritterpets, .Pplayer.Earewardmods, .Pteam.Lastrecruittype, .Psaved.Costumedata.Eaunlockedcostumerefs, .Pplayer.Pplayeraccountdata.Eapendingkeys, .Pplayer.Nemesisinfo.Eanemesisstates, .Pplayer.pEmailV2.Ilastusedid, .Pplayer.Langid, .Pplayer.Playertype, .Pplayer.eaRewardGatedData, .Pplayer.Eaplayernumericthresholds, .Pplayer.Eaastrrecentlyacquiredstickerbookitems")
	ATR_LOCKS(eaVarContainer, ".id, .Uclock, .Eaworldvars")
	ATR_LOCKS(pGuild, ".Inextactivitylogentryid, .Eaactivityentries, .Eamembers, .Pguildstatsinfo, .Htheme")
	ATR_LOCKS(pMission, ".Missionnameorig, .Starttime, .Eamissionvariables, .Children");
enumTransactionOutcome gameaction_trh_GrantSubMissions(ATR_ARGS, ATH_ARG NOCONST(Entity)* ent, ATH_ARG CONST_EARRAY_OF(NOCONST(ShardVariableContainer)) eaVarContainer, ATH_ARG NOCONST(Guild)*pGuild, ATH_ARG NOCONST(Mission)* pMission, MissionDef *pDef, CONST_EARRAY_OF(WorldGameActionProperties)* actions, WorldVariableArray* pMapVariables, GameActionDoorDestinationVarArray* pDoorDestVarArray, const char* pchInitMapVars, const char* pchMapName, const ItemChangeReason *pReason, GameAccountDataExtract *pExtract)
...
AUTO_TRANS_HELPER
	ATR_LOCKS(ent, ".Psaved.pSCPdata.Isummonedscp, .Psaved.pSCPdata.Fcachedpetbonusxppct, .Psaved.pSCPdata.erSCP, .Pinventoryv2.Peaowneduniqueitems, .Pinventoryv2.Ppinventorybags, .Hallegiance, .Hsuballegiance, .Pchar.Ilevelexp, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Pinventoryv2.Pplitebags, .Psaved.Uiindexbuild, .Psaved.Ppbuilds, .Psaved.Conowner.Containerid, .Psaved.Conowner.Containertype, .Pplayer.Eaplayernumericthresholds");
enumTransactionOutcome gameaction_trh_TakeItems(ATR_ARGS, ATH_ARG NOCONST(Entity)* ent, CONST_EARRAY_OF(WorldGameActionProperties)* actions, const ItemChangeReason *pReason, GameAccountDataExtract *pExtract)
{
	int i;	
	for (i = 0; i < eaSize(actions); i++) {
		...
		if (action->eActionType == WorldGameActionType_NPCSendMail && action->pNPCSendEmailProperties) {
			...
			if (pFromName && pSubject && pBody) {
				...
				if (pcFromName && pcSubject && pcBody) {
					...
					if (pItem) {
						pItem->count = uQuantity;
						pCharacterItems = CharacterMailAddItem(NULL, CONTAINER_RECONST(Item, pItem));
						if (!pCharacterItems) {
...
static void gameaction_CopyHeadshotToContactCostume(const WorldGameActionHeadshotProperties *pHeadshotProps, ContactCostume *pCostume)
{
	if (pCostume && pHeadshotProps) {
		switch(pHeadshotProps->eType)
		{
			...
			xcase WorldGameActionHeadshotType_Player:
				pCostume->eCostumeType = ContactCostumeType_Player;
			xdefault:
...
static void gameaction_SendNotificationToEnt(Entity *pEnt, Message *pMessage, const char *pchSound, NotifyType eNotifyType, const WorldGameActionHeadshotProperties *pHeadshotProps, const char *pchSplatFX, const char *pchLogicalString)
{
	if (pEnt) {
		...
		if (pHeadshotProps) {
			...
			contact_CostumeToHeadshotData(pEnt, pCostume, &pData, &bPlayAudio);
			...
			ClientCmd_NotifySendWithHeadshot(pEnt, eNotifyType, estrResult, pchLogicalString, bPlayAudio ? pchSound : NULL, pData);
...
static void gameaction_SendNotificationsNoTrans(Entity* ent, const WorldGameActionBlock* pActionBlock)
{
	...
	for (i = 0; i < eaSize(&pActionBlock->eaActions); i++) {
		...
		if (action->eActionType == WorldGameActionType_SendNotification && action->pSendNotificationProperties) {
			Message* pMessage = GET_REF(action->pSendNotificationProperties->notifyMsg.msg.hMessage);
			NotifyType eNotifyType = StaticDefineIntGetInt(NotifyTypeEnum, action->pSendNotificationProperties->pchNotifyType);
			const char* astrSound = gslVOGetAudioEvent(&action->pSendNotificationProperties->notifyMsg);
			if( action->pSendNotificationProperties->astrSoundOverride ) {
				astrSound = action->pSendNotificationProperties->astrSoundOverride;
			}

			gameaction_SendNotificationToEnt(ent, pMessage, astrSound, eNotifyType, action->pSendNotificationProperties->pHeadshotProperties, action->pSendNotificationProperties->pchSplatFX, action->pSendNotificationProperties->pchLogicalString);
		}
	}
}
...
enumTransactionOutcome gameaction_trh_SendNotifications(ATR_ARGS, CONST_EARRAY_OF(WorldGameActionProperties)* actions)
{
	...
	for (i = 0; i < eaSize(actions); i++) {
		WorldGameActionProperties *action = (*actions)[i];
		if (action->eActionType == WorldGameActionType_SendNotification && action->pSendNotificationProperties) {
			const char *pchMessageKey = REF_STRING_FROM_HANDLE(action->pSendNotificationProperties->notifyMsg.msg.hMessage);
			NotifyType eNotifyType = StaticDefineIntGetInt(NotifyTypeEnum, action->pSendNotificationProperties->pchNotifyType);
			...
			QueueRemoteCommand_gameaction_SendNotification(ATR_RESULT_SUCCESS, 0, 0, pchMessageKey, astrSound, eNotifyType, pHeadshot, action->pSendNotificationProperties->pchSplatFX, action->pSendNotificationProperties->pchLogicalString);
		}
	}
	return TRANSACTION_OUTCOME_SUCCESS;
}
...
static void gameaction_np_SendNotification(int iPartitionIdx, Mission* pNonPersistedMission, WorldGameActionProperties *pAction)
{
	if (pAction && pAction->eActionType == WorldGameActionType_SendNotification && pAction->pSendNotificationProperties) {
		Entity **players = NULL;
		Message *pMessage = GET_REF(pAction->pSendNotificationProperties->notifyMsg.msg.hMessage);
		...
		const char *pchSound = gslVOGetAudioEvent(&pAction->pSendNotificationProperties->notifyMsg);
		...
		int langID = -1;
		if( pAction->pSendNotificationProperties->astrSoundOverride ) {
			pchSound = pAction->pSendNotificationProperties->astrSoundOverride;
		}
											 ...
											 WorldGameActionHeadshotProperties *pHeadshotProps)
{
	...
	if (pEnt && pDef) {
		...
		contact_CostumeToHeadshotData(pEnt, pCostume, &pHeadshotData, NULL);
		if(pHeadshotProps)
...
static void gameaction_RunWarpForEnt(Entity *pEnt, const char *pcMapName, const char *pcSpawnTarget, WorldVariable **eaVariables, DoorTransitionSequenceDef* pTransSequence, bool bIncludeTeammates, bool bSinglePlayer)
{
	if (pEnt && (pcMapName || pcSpawnTarget)) {
		spawnpoint_MovePlayerToMapAndSpawn(pEnt, pcMapName, pcSpawnTarget, NULL, bSinglePlayer ? pEnt->myEntityType : 0, bSinglePlayer ? pEnt->myContainerID : 0, 0, 0, eaVariables, NULL, pTransSequence,0, bIncludeTeammates);
	}
}
	...
	for (i = 0; i < eaSize(&pActionBlock->eaActions); i++) {
		...
		if (action->eActionType == WorldGameActionType_Warp && action->pWarpProperties) {
			...
			if (dest && dest->eType == WVAR_MAP_POINT) {
				gameaction_RunWarpForEnt(ent, dest->pcZoneMap, dest->pcStringVal, vars, GET_REF(action->pWarpProperties->hTransSequence), action->pWarpProperties->bIncludeTeammates, action->pWarpProperties->bSinglePlayer);
			}
...
static void gameaction_RunWarpEntArray(Entity ***pEntArray, const char *pcMapName, const char *pcSpawnTarget, WorldVariable **eaVariables, DoorTransitionSequenceDef* pTransSequence, bool bIncludeTeammates, bool bSinglePlayer)
{
	if (pEntArray && pcMapName) {
		...
		for(i=0; i<n; i++) {
			Entity* pEnt = (*pEntArray)[i];
			if (pEnt && pEnt->pPlayer) {
				gameaction_RunWarpForEnt(pEnt, pcMapName, pcSpawnTarget, eaVariables, pTransSequence, bIncludeTeammates, bSinglePlayer);
			}
		}
	}
}
...
void gameaction_RunWarp(GameActionWarpData *pData, CmdContext *context)
{
	if (context && context->clientType == GLOBALTYPE_ENTITYPLAYER) {
		...
		if (pEnt && (pData->pcMapName || pData->pcSpawnTarget)) {
			gameaction_RunWarpForEnt(pEnt, pData->pcMapName, pData->pcSpawnTarget, NULL /*pData->eaVariables*/, NULL, 0, 0);
		}
	}
}
	...
	if (pAction && pAction->eActionType == WorldGameActionType_Warp && pAction->pWarpProperties) {
		...
		if (pNonPersistedMission && pNonPersistedMission->infoOwner && pNonPersistedMission->infoOwner->parentEnt) {
			...
			if (dest && dest->eType == WVAR_MAP_POINT ) {
				...
				gameaction_RunWarpForEnt(pNonPersistedMission->infoOwner->parentEnt, dest->pcZoneMap, dest->pcStringVal, variables, GET_REF(pAction->pWarpProperties->hTransSequence), pAction->pWarpProperties->bIncludeTeammates, pAction->pWarpProperties->bSinglePlayer);
			}
			...
			if (dest && dest->eType == WVAR_MAP_POINT) {
				gameaction_RunWarpEntArray(&players, dest->pcZoneMap, dest->pcStringVal, variables, GET_REF(pAction->pWarpProperties->hTransSequence), pAction->pWarpProperties->bIncludeTeammates, pAction->pWarpProperties->bSinglePlayer);
			}
			...
			if (pchItemDefName) {
				...
				if (pItemDef && pItemDef->flags && !(pItemDef->flags & kItemDefFlag_DoorKey)) {
					...
					if ( pItemDef != NULL ) {
						...
						destBag = itemAcquireOverride_FromGameAction(pItemDef);
						if ( destBag == InvBagIDs_None ) {
							destBag = inv_trh_GetBestBagForItemDef(ent, pItemDef, pItem, 1, false, pExtract);
							if (destBag == InvBagIDs_None) {
								destBag = InvBagIDs_Inventory;
							}
						}
