...
// Records that a Power Activation occured
void eventsend_RecordPowerActivation(SA_PARAM_OP_VALID Entity *pSourceEnt,
									 SA_PARAM_NN_VALID Entity *pTargetEnt,
									 SA_PARAM_NN_VALID PowerDef *pPowerDef);

// Records that a Power Activation ended
void eventsend_RecordPowerActivationEnded(SA_PARAM_OP_VALID Entity *pSourceEnt,
										  SA_PARAM_NN_VALID Entity *pTargetEnt,
										  SA_PARAM_NN_VALID PowerDef *pPowerDef);
