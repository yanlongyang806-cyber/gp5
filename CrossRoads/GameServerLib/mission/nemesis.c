...
AUTO_TRANSACTION
	ATR_LOCKS(pPlayerEnt, ".Psaved.pSCPdata.Isummonedscp, .Psaved.pSCPdata.Fcachedpetbonusxppct, .Psaved.pSCPdata.erSCP, .Pinventoryv2.Ppinventorybags[], .Hallegiance, .Hsuballegiance, .Pchar.Ilevelexp, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, pInventoryV2.ppLiteBags[], .Pplayer.Eaplayernumericthresholds")
	ATR_LOCKS(pNemesisEnt, ".Psaved.pSCPdata.Isummonedscp, .Psaved.pSCPdata.Fcachedpetbonusxppct, .Psaved.pSCPdata.erSCP, .Pinventoryv2.Ppinventorybags[], .Psaved.Bbadname, .Psaved.Saveddescription, .Pnemesis.Motivation, .Pnemesis.Personality, .Pnemesis.Pchpowerset, .Pnemesis.Pchminionpowerset, .Pnemesis.Pchminioncostumeset, .Pnemesis.Fpowerhue, .Pnemesis.Fminionpowerhue, .Costumeref.Hmood, .Psaved.Savedname, .Psaved.Costumedata.Uivalidatetag, .Hallegiance, .Hsuballegiance, .Psaved.Costumedata.Iactivecostume, .Psaved.Costumedata.Eacostumeslots, .Pchar.Ilevelexp, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, pInventoryV2.ppLiteBags[], .Pplayer.Eaplayernumericthresholds");
