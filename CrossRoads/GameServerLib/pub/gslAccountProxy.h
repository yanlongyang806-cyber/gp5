...
PurchaseRequestStatus gslAP_GetPurchaseStatus(U32 uAccountID, U32 uRequestID, SA_PARAM_NN_VALID char **pOutError, SA_PARAM_OP_VALID MicroPurchaseErrorType *peError);
