...
// Sets whether chat log entries should show the channel names
AUTO_COMMAND ACMD_SERVERCMD ACMD_ACCESSLEVEL(0) ACMD_NAME(Chat_SetStickyChannels) ACMD_PRIVATE;
void cmdServerChatConfig_SetStickyChannels(Entity *pEntity, bool bStickyChannels) {
	ServerChatConfig_SetStickyChannels(pEntity, bStickyChannels);
}
