...
{
	if (pPlayerEnt) {
		spawnpoint_MovePlayerToNearestSpawn(pPlayerEnt, NULL, false, true);
	}
}
...
{
	if (pPlayerEnt) {
		spawnpoint_MovePlayerToStartSpawn(pPlayerEnt, NULL, true);
	}
}
...
{
	if (pPlayerEnt) {
		spawnpoint_MovePlayerToNamedSpawn(pPlayerEnt, pcSpawnPointName, NULL, NULL, false);
	}
}
