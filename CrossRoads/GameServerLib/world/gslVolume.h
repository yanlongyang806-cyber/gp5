...
bool volume_GetVolumeData(int iPartitionIdx, SA_PARAM_NN_STR const char *pcVolumeName, SA_PARAM_OP_VALID const WorldScope* pScope, Vec3 vCenter, Vec3 vPosition, Vec3 vLocalMin, Vec3 vLocalMax, F32 *pfRot, U32 *peVolumeShape);
