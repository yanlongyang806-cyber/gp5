...
typedef void *(*StructMapperFunc)(StructMapping *pmap, void *pvSrc, Language lang);
...
void WriteMappedStructJSON(char **pestr, const char *pchDict, void *pobj, Language lang);
