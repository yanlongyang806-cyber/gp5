...
typedef enum GatewayGlobalType
{
	...
	GW_GLOBALTYPE_CSTORE,
	GW_GLOBALTYPE_VENDOR,
	// Add new types here

	GW_GLOBALTYPE_MAX
} GatewayGlobalType;

#define GATEWAY_CONTAINER_MAX_DEPS 16
...
typedef struct ContainerMapping
{
	...
	GatewayGlobalType *pDependentContainers;
		// When this container is marked as modified, all containers of the types
		//  in this list will also be marked as modified
...
#define CONTAINER_MAPPING_LOGIN_ENTITY( deps ) { "LoginEntity", GW_GLOBALTYPE_LOGIN_ENTITY, GLOBALTYPE_ENTITYPLAYER, NULL, parse_MappedLoginEntity, true, SubscribeDBContainer, NULL, NULL, IsReadyDBContainer, CreateMappedLoginEntity, DestroyMappedLoginEntity, offsetof(ContainerTracker, hEntity), deps }
#define CONTAINER_MAPPING_LOGIN_ENTITY_NODEPS() { "LoginEntity", GW_GLOBALTYPE_LOGIN_ENTITY, GLOBALTYPE_ENTITYPLAYER, NULL, parse_MappedLoginEntity, true, SubscribeDBContainer, NULL, NULL, IsReadyDBContainer, CreateMappedLoginEntity, DestroyMappedLoginEntity, offsetof(ContainerTracker, hEntity)  }
