...
AUTO_TRANSACTION
ATR_LOCKS(pEnt, ".Pchar.Hpath, .Pplayer.Eskillspecialization, .Pchar.Hclass, .Pchar.Ppsecondarypaths, .Psaved.pSCPdata.Isummonedscp, .Psaved.pSCPdata.Fcachedpetbonusxppct, .Psaved.pSCPdata.erSCP, .Pplayer.Skilltype, .pInventoryV2.Ppinventorybags, .Hallegiance, .Hsuballegiance, .Psaved.Ppallowedcritterpets, .Psaved.Costumedata.Eaunlockedcostumerefs, .Pplayer.Pplayeraccountdata.Eapendingkeys, .Itemidmax, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Pchar.Ilevelexp, .Psaved.Uiindexbuild, .Psaved.Ppbuilds, .Psaved.Conowner.Containerid, .Psaved.Conowner.Containertype, .Psaved.Ppownedcontainers, .Pchar.Uipoweridmax, .Psaved.Ipetid, .Psaved.Ppuppetmaster.Curid, .Psaved.Ppuppetmaster.Curtype, .Psaved.Ppuppetmaster.Curtempid, .Pplayer.Playertype, .pInventoryV2.Pplitebags, .pInventoryV2.Peaowneduniqueitems, .Pplayer.Eaplayernumericthresholds, .Pplayer.Eaastrrecentlyacquiredstickerbookitems")
											 ...
											 const ItemChangeReason *pReason, GameAccountDataExtract *pExtract)
{
	...
	recipe_iter = bagiterator_Create();
	
	if (!inv_bag_trh_FindItemByDefName(ATR_PASS_ARGS, pEnt,InvBagIDs_Recipe,pchRecipeName,0,recipe_iter))
	{
...
AUTO_TRANSACTION
ATR_LOCKS(pEnt, ".Pplayer.Eaplayernumericthresholds, .Psaved.Pscpdata.Isummonedscp, .Psaved.Pscpdata.Fcachedpetbonusxppct, .Psaved.Pscpdata.Erscp, .pInventoryV2.Peaowneduniqueitems, pInventoryV2.ppLiteBags, .pInventoryV2.Ppinventorybags, .Psaved.Conowner.Containertype, .Hallegiance, .Hsuballegiance, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Psaved.Uiindexbuild, .Psaved.Ppbuilds, .Psaved.Conowner.Containerid, .Pchar.Ilevelexp");
...
AUTO_TRANS_HELPER
ATR_LOCKS(pEnt, ".Psaved.pSCPdata.Isummonedscp, .Psaved.pSCPdata.Fcachedpetbonusxppct, .Psaved.pSCPdata.erSCP, .Hallegiance, .Hsuballegiance, .Psaved.Conowner.Containerid, .Psaved.Conowner.Containertype, .pInventoryV2.Ppinventorybags, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Pchar.Ilevelexp, .Psaved.Uiindexbuild, .Psaved.Ppbuilds, .pInventoryV2.Peaowneduniqueitems, pInventoryV2.ppLiteBags, .Pplayer.Eaplayernumericthresholds");
...
AUTO_TRANSACTION
ATR_LOCKS(pEnt, ".Pplayer.Accountid, .Psaved.pSCPdata.Isummonedscp, .Psaved.pSCPdata.Fcachedpetbonusxppct, .Psaved.pSCPdata.erSCP, .Hallegiance, .Hsuballegiance, .Pchar.Ilevelexp, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .pInventoryV2.Ppinventorybags, .Psaved.Costumedata.Eaunlockedcostumerefs, .Pplayer.Pplayeraccountdata.Eapendingkeys, .pInventoryV2.Peaowneduniqueitems, pInventoryV2.ppLiteBags, .Psaved.Uiindexbuild, .Psaved.Ppbuilds, .Psaved.Conowner.Containerid, .Psaved.Conowner.Containertype, .Pplayer.Eaplayernumericthresholds")
...
AUTO_TRANSACTION
ATR_LOCKS(pEnt, ".Pplayer.Accountid, .Psaved.pSCPdata.Isummonedscp, .Psaved.pSCPdata.Fcachedpetbonusxppct, .Psaved.pSCPdata.erSCP, .Psaved.Conowner.Containertype, .pInventoryV2.Peaowneduniqueitems, .pInventoryV2.Ppinventorybags, .Hallegiance, .Hsuballegiance, .Pchar.Ilevelexp, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Psaved.Uiindexbuild, .Psaved.Ppbuilds, .Psaved.Conowner.Containerid, pInventoryV2.ppLiteBags, .Pplayer.Eaplayernumericthresholds")
ATR_LOCKS(pProxyLock, ".Plock.Uaccountid, .Plock.Pkey, .Plock.Result, .Plock.Fdestroytime, .Plock.Etransactiontype");
...
ATR_LOCKS(pEnt, ".Pplayer.Accountid, .Psaved.pSCPdata.Isummonedscp, .Psaved.pSCPdata.Fcachedpetbonusxppct, .Psaved.pSCPdata.erSCP, .Psaved.Conowner.Containertype, .pInventoryV2.Peaowneduniqueitems, .pInventoryV2.Ppinventorybags, .Hallegiance, .Hsuballegiance, .Pchar.Ilevelexp, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Psaved.Uiindexbuild, .Psaved.Ppbuilds, .Psaved.Conowner.Containerid, pInventoryV2.ppLiteBags, .Pplayer.Eaplayernumericthresholds")
ATR_LOCKS(pProxyLock, ".Plock.Uaccountid, .Plock.Pkey, .Plock.Result, .Plock.Fdestroytime, .Plock.Etransactiontype");
enumTransactionOutcome tr_ItemBuyAndRemoveAll(ATR_ARGS, NOCONST(Entity)* pEnt, NOCONST(AccountProxyLockContainer)* pProxyLock,
											  int iTargetBagID, StoreDef *pStoreDef, ContactDialog *pContactDialog, const char *pcCurrency,
											  const ItemChangeReason *pReason, GameAccountDataExtract *pExtract)
{
	int i, j, iCount;
	StoreItemInfo** eaStoreItems = pContactDialog ? pContactDialog->eaStoreItems : NULL;

	if (!pContactDialog)
		TRANSACTION_RETURN_LOG_FAILURE("No contact dialog found");

	if (!eaStoreItems || eaSize(&eaStoreItems) < 1)
		TRANSACTION_RETURN_LOG_FAILURE("No store items found");

	for (i = eaSize(&eaStoreItems) - 1; i >= 0; i--)
	{
		StoreItemInfo *pStoreItemInfo = eaStoreItems[i];
		iCount = pStoreItemInfo->iCount;

		for (j = eaSize(&pStoreItemInfo->eaCostInfo) - 1; j >= 0; j--)
		{
			StoreItemDef *pStoreItemDef = eaGet(&pStoreDef->inventory, pStoreItemInfo->index);
			ItemDef *pItemDef = pStoreItemDef ? GET_REF(pStoreItemDef->hItem) : NULL;

			if (pStoreItemDef && pItemDef)
			{
				StoreItemCostInfo *pCostInfo = pStoreItemInfo->eaCostInfo[j];
				ItemDef *pCurrencyDef = pCostInfo ? GET_REF(pCostInfo->hItemDef) : NULL;

				if (pCurrencyDef)
				{
					iCount = MIN(iCount, inv_ent_trh_AllBagsCountItems(ATR_PASS_ARGS, pEnt, pCurrencyDef->pchName, NULL));
				}
				...
				if (iCount > 0)
				{
					...
					tr_ItemBuyAndRemove(ATR_PASS_ARGS, pEnt, pProxyLock, iTargetBagID, pItemDef, iCount,
						&CostInfoList, pcCurrency, pStoreItemDef, pReason, pExtract);
				}
			}
		}
	}
...
// Player entity spends the cost of the item and the item is removed from the target entity
AUTO_TRANSACTION
ATR_LOCKS(pEnt, ".Pplayer.Accountid, .Psaved.pSCPdata.Isummonedscp, .Psaved.pSCPdata.Fcachedpetbonusxppct, .Psaved.pSCPdata.erSCP, .Psaved.Conowner.Containertype, .pInventoryV2.Peaowneduniqueitems, .Hallegiance, .Hsuballegiance, .Pchar.Ilevelexp, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .pInventoryV2.Ppinventorybags, .Psaved.Uiindexbuild, .Psaved.Ppbuilds, .Psaved.Conowner.Containerid, pInventoryV2.ppLiteBags, .Pplayer.Eaplayernumericthresholds")
ATR_LOCKS(pTargetEnt, ".Pplayer.Eaplayernumericthresholds, .Psaved.Pscpdata.Isummonedscp, .Psaved.Pscpdata.Fcachedpetbonusxppct, .Psaved.Pscpdata.Erscp, .Psaved.Conowner.Containerid, .Hallegiance, .Hsuballegiance, .Pchar.Ilevelexp, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Psaved.Uiindexbuild, .Psaved.Ppbuilds, .Psaved.Conowner.Containertype, .pInventoryV2.Peaowneduniqueitems, pInventoryV2.ppInventoryBags[], pInventoryV2.ppLiteBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[]")
ATR_LOCKS(pProxyLock, ".Plock.Uaccountid, .Plock.Pkey, .Plock.Result, .Plock.Fdestroytime, .Plock.Etransactiontype");
...
ATR_LOCKS(pTargetEnt, ".Pplayer.Eaplayernumericthresholds, .Psaved.Pscpdata.Isummonedscp, .Psaved.Pscpdata.Fcachedpetbonusxppct, .Psaved.Pscpdata.Erscp, .Psaved.Conowner.Containerid, .Hallegiance, .Hsuballegiance, .Pchar.Ilevelexp, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Psaved.Uiindexbuild, .Psaved.Ppbuilds, .Psaved.Conowner.Containertype, .pInventoryV2.Peaowneduniqueitems, pInventoryV2.ppInventoryBags[], pInventoryV2.ppLiteBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[]")
ATR_LOCKS(pProxyLock, ".Plock.Uaccountid, .Plock.Pkey, .Plock.Result, .Plock.Fdestroytime, .Plock.Etransactiontype");
enumTransactionOutcome tr_ItemBuyAndRemoveAllAcrossEnts(ATR_ARGS, NOCONST(Entity)* pEnt, NOCONST(Entity)* pTargetEnt, NOCONST(AccountProxyLockContainer)* pProxyLock,
														int iTargetBagID, StoreDef *pStoreDef, ContactDialog *pContactDialog, const char *pcCurrency,
														const ItemChangeReason *pReason, GameAccountDataExtract *pExtract)
{
	int i, j, iCount;
		...
		if (pStoreItemDef && pItemDef)
		{
			for (j = eaSize(&pStoreItemInfo->eaCostInfo) - 1; j >= 0; j--)
			{
				...
				if (iCount > 0)
				{
					...
					CostInfoList.eaCostInfo = pStoreItemInfo->eaCostInfo;
					CostInfoList.iStoreItemCount = MAX(SAFE_MEMBER(pStoreItemDef, iCount), 1);
					tr_ItemBuyAndRemoveAcrossEnts(ATR_PASS_ARGS, pEnt, pTargetEnt, pProxyLock,
						iTargetBagID, pItemDef, iCount, &CostInfoList, pcCurrency, pStoreItemDef, pReason, pExtract);
				}
			}
		}
	}
...
AUTO_TRANSACTION
ATR_LOCKS(pEnt, ".Pplayer.Accountid, .Psaved.pSCPdata.Isummonedscp, .Psaved.pSCPdata.Fcachedpetbonusxppct, .Psaved.pSCPdata.erSCP, .Hallegiance, .Hsuballegiance, .Psaved.Ppuppetmaster.Curtype, .Psaved.Ppuppetmaster.Curtempid, .Pchar.Ilevelexp, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Psaved.Ppallowedcritterpets, .Psaved.Uiindexbuild, .Psaved.Ppbuilds, .Psaved.Conowner.Containerid, .Psaved.Conowner.Containertype, .Pinventoryv2.Peaowneduniqueitems, .Pinventoryv2.Ppinventorybags, .Pinventoryv2.Pplitebags, .Pplayer.Playertype, .Psaved.Ppownedcontainers, .Itemidmax, .Pchar.Uipoweridmax, .Psaved.Ipetid, .Psaved.Ppuppetmaster.Curid, .Pplayer.Eaplayernumericthresholds, .Pplayer.Eaastrrecentlyacquiredstickerbookitems")
ATR_LOCKS(eaPets, ".Pcritter.Petdef, .Pinventoryv2.Peaowneduniqueitems")
...
AUTO_TRANSACTION
ATR_LOCKS(pEnt, ".Psaved.Pscpdata.Fcachedpetbonusxppct, .Hallegiance, .Hsuballegiance, .Psaved.Pscpdata.Erscp, .Pplayer.Eaplayernumericthresholds, .Pchar.Ilevelexp, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Psaved.Uiindexbuild, .Psaved.Ppbuilds, .Psaved.Conowner.Containerid, .Psaved.Conowner.Containertype, .Pinventoryv2.Peaowneduniqueitems, .Psaved.Pscpdata.Isummonedscp, pInventoryV2.ppInventoryBags[], pInventoryV2.ppLiteBags[]");
enumTransactionOutcome tr_ItemSellFromBag(ATR_ARGS, NOCONST(Entity)* pEnt, int BagID, const char *pcItemName, int iSlot, U64 uItemID, int iCount, int iCost, const char *pcCurrency, const ItemChangeReason *pReason, GameAccountDataExtract *pExtract)
{
	...
	else
	{
		...
		{
			Item* pItem = invbag_RemoveItem(ATR_PASS_ARGS, pEnt, false, BagID, iSlot, iCount, false, pReason, pExtract);
			success = !!pItem;
...
// and shouldn't really be needed anyway).
AUTO_TRANSACTION
ATR_LOCKS(pEnt, ".Psaved.pSCPdata.Isummonedscp, .Psaved.pSCPdata.Fcachedpetbonusxppct, .Psaved.pSCPdata.erSCP, .Pinventoryv2.Ppinventorybags[], .Hallegiance, .Hsuballegiance, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Pchar.Ilevelexp, pInventoryV2.ppLiteBags[], .Pplayer.Eaplayernumericthresholds") 
ATR_LOCKS(pPetEnt, ".Pplayer.Eaplayernumericthresholds, .Psaved.Pscpdata.Isummonedscp, .Psaved.Pscpdata.Fcachedpetbonusxppct, .Psaved.Pscpdata.Erscp, .Psaved.Conowner.Containerid, .Hallegiance, .Hsuballegiance, .Pchar.Ilevelexp, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Psaved.Uiindexbuild, .Psaved.Ppbuilds, .Psaved.Conowner.Containertype, .Pinventoryv2.Peaowneduniqueitems, pInventoryV2.ppInventoryBags[], pInventoryV2.ppLiteBags[], pInventoryV2.ppLiteBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[]");
enumTransactionOutcome tr_ItemSellFromBagFromPet(ATR_ARGS, NOCONST(Entity)* pEnt, NOCONST(Entity)* pPetEnt, int BagID, const char *pcItemName, int iSlot, U64 uItemID, int iCount, int iCost, const char *pcCurrency, const ItemChangeReason *pReason, GameAccountDataExtract *pExtract)
{
	...
	if (iSlot < 0) {
		...
		if (NONNULL(pCheckItem) && pCheckItem->id == uItemID)
		{
			Item* pItem = invbag_RemoveItem(ATR_PASS_ARGS, pPetEnt, false, BagID, iSlot, iCount, false, pReason, pExtract);
			success = !!pItem;
			StructDestroySafe(parse_Item,&pItem);
		}
	}
...
AUTO_TRANSACTION
ATR_LOCKS(pEnt, ".Psaved.pSCPdata.Isummonedscp, .Psaved.pSCPdata.Fcachedpetbonusxppct, .Psaved.pSCPdata.erSCP, .pInventoryV2.Peaowneduniqueitems, pInventoryV2.ppLiteBags, .Psaved.Ppuppetmaster.Curtype, .pInventoryV2.Ppinventorybags, .Hallegiance, .Hsuballegiance, .Psaved.Ppuppetmaster.Curtempid, .Psaved.Ppallowedcritterpets, .Itemidmax, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Pchar.Ilevelexp, .Psaved.Uiindexbuild, .Psaved.Ppbuilds, .Psaved.Conowner.Containerid, .Psaved.Conowner.Containertype, .Psaved.Ppownedcontainers, .Pchar.Uipoweridmax, .Psaved.Ipetid, .Psaved.Ppuppetmaster.Curid, .Pplayer.Playertype, .Pplayer.Eaplayernumericthresholds, .Pplayer.Eaastrrecentlyacquiredstickerbookitems");
...
static void ItemLevelUpPowerFactorCB(TransactionReturnVal *pVal, PowerFactorLevelUpCBData *pData)
{
	...
	if(pEnt)
	{
/////  This is a public facing transaction. If we gslSendPrintf then the players will see it. Since we
/////  cannot create a proper public-facing message, don't send one. (NW uses this for training mounts, another
/////  game (or even a different application in NW) might not use mounts.		
...
AUTO_TRANSACTION
ATR_LOCKS(pEnt, ".Pplayer.Eaplayernumericthresholds, .Psaved.Pscpdata.Isummonedscp, .Psaved.Pscpdata.Fcachedpetbonusxppct, .Psaved.Pscpdata.Erscp, .Psaved.Conowner.Containertype, .Pinventoryv2.Peaowneduniqueitems, .Pinventoryv2.Pplitebags, .Pinventoryv2.Ppinventorybags, .Hallegiance, .Hsuballegiance, .Pchar.Ilevelexp, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Psaved.Uiindexbuild, .Psaved.Ppbuilds, .Psaved.Conowner.Containerid");
...
static int findItemsInBindState(Entity *pEnt, const char *pchItemName, U64 ulItemID, bool bBound, Item **ppItem)
{
	...
	if(pItemDef)
	{
		...
		for(ii=eaSize(&pEnt->pInventoryV2->ppInventoryBags)-1;ii>=0;ii--)
		{
			...
			BagIterator *iter = bagiterator_Create();
			bagiterator_SetBag(CONTAINER_NOCONST(InventoryBag, pBag), iter);
...
AUTO_TRANSACTION
	ATR_LOCKS(pEnt, ".Psaved.pSCPdata.Isummonedscp, .Psaved.pSCPdata.Fcachedpetbonusxppct, .Psaved.pSCPdata.erSCP, .Pchar.Ppsecondarypaths, .Pchar.Hpath, .Pplayer.Skilltype, .Pplayer.Eskillspecialization, .Pchar.Hclass, .Psaved.Ppallowedcritterpets, .pInventoryV2.Ppinventorybags, .Psaved.Uiindexbuild, .Psaved.Ppbuilds, .Hallegiance, .Hsuballegiance, .Pchar.Ilevelexp, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .pInventoryV2.Pplitebags, .Pplayer.Playertype, .Psaved.Costumedata.Eaunlockedcostumerefs, .Pplayer.Pplayeraccountdata.Eapendingkeys, .Psaved.Ppownedcontainers, .pInventoryV2.Peaowneduniqueitems, .Itemidmax, .Psaved.Conowner.Containerid, .Psaved.Conowner.Containertype, .Pchar.Uipoweridmax, .Psaved.Ipetid, .Psaved.Ppuppetmaster.Curid, .Psaved.Ppuppetmaster.Curtype, .Psaved.Ppuppetmaster.Curtempid, .Pplayer.Eaplayernumericthresholds, .Pplayer.Eaastrrecentlyacquiredstickerbookitems")
	ATR_LOCKS(eaPets, ".Pcritter.Petdef, .pInventoryV2.Peaowneduniqueitems");
											  ...
											  GameAccountDataExtract* pExtract)
{
	...
	pItem = CONTAINER_NOCONST(Item, invbag_RemoveItem(ATR_PASS_ARGS, pEnt, false, eRewardPackBagID, iRewardPackBagSlot, 1, false, pReason, pExtract));
	if (ISNULL(pItem))
	{
		return TRANSACTION_OUTCOME_FAILURE;
	}
...
AUTO_TRANSACTION
	ATR_LOCKS(pEnt, ".Psaved.pSCPdata.Isummonedscp, .Psaved.pSCPdata.Fcachedpetbonusxppct, .Psaved.pSCPdata.erSCP, .pInventoryV2.ppInventoryBags[], .Hallegiance, .Hsuballegiance, .Psaved.Ppbuilds, .pInventoryV2.Peaowneduniqueitems, pInventoryV2.ppLiteBags[], .Psaved.Conowner.Containerid, .Psaved.Conowner.Containertype, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Pchar.Ilevelexp, .Pplayer.Pplayeraccountdata.Iversion, .Psaved.Uiindexbuild, pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], .Pplayer.Eaplayernumericthresholds")
	...
	GameAccountDataExtract* pExtract)
{
	...
	pItem = CONTAINER_NOCONST(Item, invbag_RemoveItem(ATR_PASS_ARGS, pEnt, false, eBagID, iBagSlot, 1, false, pReason, pExtract));
	if (ISNULL(pItem))
	{
...
AUTO_TRANSACTION
ATR_LOCKS(pEnt, ".Psaved.pSCPdata.Isummonedscp, .Psaved.pSCPdata.Fcachedpetbonusxppct, .Psaved.pSCPdata.erSCP, .Hallegiance, .Hsuballegiance, pInventoryV2.ppLiteBags[], .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Pchar.Ilevelexp,, pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], .Pplayer.Eaplayernumericthresholds");
...
AUTO_TRANSACTION
ATR_LOCKS(pEnt, ".Psaved.pSCPdata.Isummonedscp, .Psaved.pSCPdata.Fcachedpetbonusxppct, .Psaved.pSCPdata.erSCP, .Hallegiance, .Hsuballegiance, .Psaved.Ppbuilds, .Psaved.Conowner.Containerid, .Psaved.Conowner.Containertype, .pInventoryV2.Peaowneduniqueitems, pInventoryV2.ppLiteBags[], .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Pchar.Ilevelexp, .Psaved.Uiindexbuild, pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], .Pplayer.Eaplayernumericthresholds");
...
//		Channel 3
	...
	inv_bag_trh_RemoveItem(ATR_PASS_ARGS, pEnt, false, inv_trh_GetBag(ATR_PASS_ARGS, pEnt, iDyeBag, NULL), iDyeSlot, 1, false, pReason);
...
AUTO_TRANSACTION
ATR_LOCKS(pEnt, ".Psaved.Pscpdata.Isummonedscp, .Psaved.Pscpdata.Erscp, .Psaved.Pscpdata.Fcachedpetbonusxppct, .Psaved.Conowner.Containerid, .Hallegiance, .Hsuballegiance, .Pchar.Ilevelexp, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Psaved.Uiindexbuild, .Psaved.Ppbuilds, .Psaved.Conowner.Containertype, .Pinventoryv2.Peaowneduniqueitems, pInventoryV2.ppInventoryBags[], pInventoryV2.ppLiteBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], .Pplayer.Eaplayernumericthresholds, .Pplayer.Skilltype, .Pplayer.Eskillspecialization, .Pchar.Hclass, .Pchar.Ppsecondarypaths, .Pchar.Hpath");
	...
	S32 iMainItemBag, S32 iMainItemSlot, S32 iTransmutateToItemBag, S32 iTransmutateToItemSlot, S32 iCost, ItemChangeReason* pReason)
{
	...
	if (ISNULL(pMainItem) || ISNULL(pTransmutateToItem) || !pMainItemDef || !pTransmutateToItemDef || 
		...
		!item_trh_CanTransMutateTo(ATR_PASS_ARGS, pEnt, pMainItem, pMainItemDef, pTransmutateToItem, pTransmutateToItemDef))
	{
		return TRANSACTION_OUTCOME_FAILURE;
	}
	...
	//Copy bound state
	if (pTransmutateToItem->flags & kItemFlag_Bound)
		pMainItem->flags |= kItemFlag_Bound;
	else if (pTransmutateToItem->flags & kItemFlag_BoundToAccount)
		pMainItem->flags |= kItemFlag_BoundToAccount;

	inv_bag_trh_RemoveItem(ATR_PASS_ARGS, pEnt, false, inv_trh_GetBag(ATR_PASS_ARGS, pEnt, iTransmutateToItemBag, NULL), iTransmutateToItemSlot, 1, false, pReason);
	...
	U64 uMainItemID, U64 uTransmutateToItemID)
{
	...
	//Bail if we're missing either of these
	if(!pStats || !pAppearance) {
		return;
	}
