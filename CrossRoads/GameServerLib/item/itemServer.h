...
void ItemOpenRewardPackWithChoices(int iPartitionIdx, Entity *pEnt, Item *pItem, ItemDef *pItemDef, InvBagIDs eBagID, S32 iSlot, char **ppItemChoices);
#endif
