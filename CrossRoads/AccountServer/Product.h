...
typedef struct ProductContainer
{
	...
	const bool bRequireEmployee;								AST(PERSIST)
	...
	const U32 uStartDateSS2000;									AST(PERSIST) // The date (timeSecondsSince2000) the product become available
	const U32 uEndDateSS2000;									AST(PERSIST) // The date (timeSecondsSince2000) the product become unavailable
