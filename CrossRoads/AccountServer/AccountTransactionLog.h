...
typedef struct TransactionLogContainer
{
	...
	CONST_STRING_MODIFIABLE pPWOrderID;
...
typedef struct TransactionLogContainer_AutoGen_NoConst TransactionLogContainer_AutoGen_NoConst;
...
// Open a new transaction log without performing a transaction. Populate via the other functions below.
...
void AccountTransactionFinishNonTransacted(SA_PRE_NN_NN_VALID SA_POST_NN_NULL NOCONST(TransactionLogContainer) **ppLog);
