...
static void wiHandleAdminIndex(SA_PARAM_NN_VALID WICWebRequest *pWebRequest)
{
...
static void wiHandleAdminStats(SA_PARAM_NN_VALID WICWebRequest *pWebRequest)
{
	if (!verify(pWebRequest)) return;
...
static void wiHandleAdminDebug(SA_PARAM_NN_VALID WICWebRequest *pWebRequest)
{
	if (!verify(pWebRequest)) return;
...
static void wiHandleAdminDiscounts_SaveDiscount(SA_PARAM_NN_VALID WICWebRequest *pWebRequest,
...
static void wiHandleAdminDiscounts(SA_PARAM_NN_VALID WICWebRequest *pWebRequest)
{
...
static void wiHandleAdminCurrency_SaveCurrency(WICWebRequest *pWebRequest, ASWICurrencies *paswiCurrencies)
{
...
static void wiHandleAdminCurrency_EditCurrency(WICWebRequest *pWebRequest, ASWICurrencies *paswiCurrencies)
{
...
static void wiHandleAdminCurrency(SA_PARAM_NN_VALID WICWebRequest *pWebRequest)
{
...
static void wiHandleAdminIPRateLimit(SA_PARAM_NN_VALID WICWebRequest *pWebRequest)
{
