...
static void wiHandleProductKeysIndex(SA_PARAM_NN_VALID WICWebRequest *pWebRequest)
{
...
static void wiHandleProductKeysView(SA_PARAM_NN_VALID WICWebRequest *pWebRequest)
{
	if (!verify(pWebRequest)) return;
...
static void wiHandleProductKeysList(SA_PARAM_NN_VALID WICWebRequest *pWebRequest)
{
	if (!verify(pWebRequest)) return;
...
static void wiHandleProductKeysCreate(SA_PARAM_NN_VALID WICWebRequest *pWebRequest)
{
	if (!verify(pWebRequest)) return;
...
bool wiHandleProductKeys(SA_PARAM_NN_VALID WICWebRequest *pWebRequest)
{
	bool bHandled = false;
