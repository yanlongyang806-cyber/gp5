...
S64 KeyValueTest_Get(const char *pAccountName, const char *pKey)
{
	...
	eResult = AccountKeyValue_GetLocked("KVTest", pAccount, pKey, &iValue);
	return iValue;
}
...
char *KeyValueTest_Lock(const char *pAccountName, const char *pKey)
{
	...
	eResult = AccountKeyValue_Lock("KVTest", pAccount, pKey, &pLock);
	return pLock;
}
...
bool KeyValueTest_LockAgain(const char *pAccountName, const char *pKey, char *pLock)
{
	...
	eResult = AccountKeyValue_LockAgain("KVTest", pAccount, pKey, &pLock);
	return eResult == AKV_SUCCESS;
}

AUTO_COMMAND ACMD_NAME(KVLockWithChange);
char *KeyValueTest_LockWithChange(const char *pAccountName, const char *pKey, S64 iChange)
{
	AccountInfo *pAccount = findAccountByName(pAccountName);
	AccountKeyValueResult eResult = AKV_FAILURE;
	char *pLock = NULL;
	...
	eResult = AccountKeyValue_LockEx("KVTest", pAccount, pKey, iChange, true, &pLock, true);
	return pLock;
}
...
char *KeyValueTest_SetOnce(const char *pAccountName, const char *pKey, S64 iValue)
{
	...
	eResult = AccountKeyValue_SetOnce("KVTest", pAccount, pKey, iValue, &pLock);
	return pLock;
}
...
bool KeyValueTest_Set(const char *pAccountName, const char *pKey, S64 iValue, char *pLock)
{
	...
	eResult = AccountKeyValue_Set("KVTest", pAccount, pKey, iValue, &pLock);
	return eResult == AKV_SUCCESS;
}
...
char *KeyValueTest_ChangeOnce(const char *pAccountName, const char *pKey, S64 iValue)
{
	...
	eResult = AccountKeyValue_ChangeOnce("KVTest", pAccount, pKey, iValue, &pLock);
	return pLock;
}
...
bool KeyValueTest_Change(const char *pAccountName, const char *pKey, S64 iValue, char *pLock)
{
	...
	eResult = AccountKeyValue_Change("KVTest", pAccount, pKey, iValue, &pLock);
	return eResult == AKV_SUCCESS;
}
...
char *KeyValueTest_MoveOnce(const char *pAccountNameFrom, const char *pKeyFrom, const char *pAccountNameTo, const char *pKeyTo, S64 iValue)
{
	...
	eResult = AccountKeyValue_MoveOnce("KVTest", pAccountFrom, pKeyFrom, pAccountTo, pKeyTo, iValue, &pLock);
	return pLock;
}
...
bool KeyValueTest_Move(const char *pAccountNameFrom, const char *pKeyFrom, const char *pAccountNameTo, const char *pKeyTo, S64 iValue, char *pLock)
{
	...
	eResult = AccountKeyValue_Move("KVTest", pAccountFrom, pKeyFrom, pAccountTo, pKeyTo, iValue, &pLock);
	return eResult == AKV_SUCCESS;
}
...
bool KeyValueTest_Commit(const char *pAccountName, const char *pKey, const char *pPassword)
{
	...
	eResult = AccountKeyValue_Commit("KVTest", pAccount, pKey, pPassword);
	return eResult == AKV_SUCCESS;
}

AUTO_COMMAND ACMD_NAME(KVForceCommit);
bool KeyValueTest_ForceCommit(const char *pAccountName, const char *pKey)
{
	AccountInfo *pAccount = findAccountByName(pAccountName);
	AccountKeyValueResult eResult = AKV_FAILURE;
	...
	eResult = AccountKeyValue_ForceCommit("KVTest", pAccount, pKey);
	return eResult == AKV_SUCCESS;
}
...
bool KeyValueTest_Rollback(const char *pAccountName, const char *pKey, const char *pPassword)
{
	...
	eResult = AccountKeyValue_Rollback("KVTest", pAccount, pKey, pPassword);
	return eResult == AKV_SUCCESS;
}