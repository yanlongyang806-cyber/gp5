...
void executeUserCommandWait (const U32 userID, const char *userHandle)
{
	int i, j;
...
void blacklist_Violation(ChatUser *user, const char *string)
{
	...
	{
		sendChatSystemTranslatedNotify(user, kNotifyType_ChatBlacklist, "ChatServer_BlacklistWarning", STRFMT_END);
	}
}
