...
/*
F32	pointPlaneDist(Vec3 VV1,Vec3 NN1,Vec3 pt)
{
F32	PEQD1;

    PEQD1 = -(NN1[0]*VV1[0] + NN1[1]*VV1[1] + NN1[2]*VV1[2]);
	return NN1[0]*pt[0] + NN1[1]*pt[1] + NN1[2]*pt[2] + PEQD1;
}
*/
int	VWhichSide(Vec3 VV1,Vec3 NN1,Vec3 pt)
{
F32	s;

	s = pointPlaneDist(VV1,NN1,pt);
