...
{
#if IS_CRYPTIC_EXPORTER
	return "Cryptic Exporter";
#else
	return "Animation Exporter";
#endif
}
...
public:
	...
	const TCHAR*	ClassName() { return "CryptExp"; }
#else
...
{
#if IS_CRYTPIC_EXPORTER
	return "Cryptic Anim and VRML Exporter";
#else
	return "Cryptic Animation Exporter";
#endif
}
...
{
	return "Copyright 2000 Autodesk, Inc., 2004-2011 Cryptic Studios";
}
...
{
	return "3ds Max Skeleton/Scaling Info exporter";
}

const TCHAR * SkelExp::ShortDesc()
{
	return "DSkel Exporter";
}
