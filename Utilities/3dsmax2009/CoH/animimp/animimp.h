...
class AnimRecord {
public:
	AnimRecord() { frames=NULL;};
	~AnimRecord() { if (frames) delete[] frames; };
...
public:
	...
	int readAnimRecord(AnimRecord *record);
	int numAnimRecords;
	int numFrames;
	AnimRecord *records;
	AnimRecord *findAnimRecord(const char *name);
...
// you should change!
#define AnimExp_CLASS_ID	Class_ID(0x89528e1b, 0x4a2347c3)
