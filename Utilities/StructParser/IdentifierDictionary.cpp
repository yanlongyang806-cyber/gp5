...
bool IdentifierDictionary::SetFileNameAndLoad(char *pProjPath, char *pProjFileName)
{
	...
	do
	{
		...
		ASSERT(&tokenizer,eType == TOKEN_STRING, "Didn't find identifier name"); 
