 ...
 *
 * The XML for this response can be found here: \ref Account_AuthToken_Login_1
 * 
...
typedef struct vx_resp_aux_get_vad_properties {
    vx_resp_base_t base;
    /**
    * The 'Hangover time' - the time (in seconds) that it takes for the VAD to switch back to silence 
