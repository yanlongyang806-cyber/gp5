...
extern "C" {
    ...
    typedef enum {
        ...
        req_max=req_account_authtoken_login+1
    } vx_request_type;
    ...
    typedef enum {
        ...
        resp_max=resp_account_authtoken_login+1
    } vx_response_type;
...
#ifndef VIVOX_TYPES_ONLY
    VIVOXSDK_DLLEXPORT void vx_state_buddy_contact_create(vx_state_buddy_contact_t** contact);
    VIVOXSDK_DLLEXPORT void vx_state_buddy_contact_free(vx_state_buddy_contact_t* contact);
#endif
...
#ifndef VIVOX_TYPES_ONLY
    VIVOXSDK_DLLEXPORT void vx_state_buddy_contact_list_create(int size, vx_state_buddy_contact_list_t* list_out);
    VIVOXSDK_DLLEXPORT void vx_state_buddy_contact_list_free(vx_state_buddy_contact_t** list, int size);
#endif
...
#ifndef VIVOX_TYPES_ONLY
    VIVOXSDK_DLLEXPORT void vx_state_buddy_create(vx_state_buddy_t** buddy);
    VIVOXSDK_DLLEXPORT void vx_state_buddy_free(vx_state_buddy_t* buddy);
#endif
    typedef vx_state_buddy_t* vx_state_buddy_ref_t;
    typedef vx_state_buddy_ref_t* vx_state_buddy_list_t;
#ifndef VIVOX_TYPES_ONLY
    VIVOXSDK_DLLEXPORT void vx_state_buddy_list_create(int size, vx_state_buddy_list_t* list_out);
    VIVOXSDK_DLLEXPORT void vx_state_buddy_list_free(vx_state_buddy_t** list, int size);
#endif
...
#ifndef VIVOX_TYPES_ONLY
    VIVOXSDK_DLLEXPORT void vx_state_buddy_group_create(vx_state_buddy_group_t** group);
    VIVOXSDK_DLLEXPORT void vx_state_buddy_group_free(vx_state_buddy_group_t* group);
#endif
    typedef vx_state_buddy_group_t* vx_state_buddy_group_ref_t;
    typedef vx_state_buddy_group_ref_t* vx_state_buddy_group_list_t;
#ifndef VIVOX_TYPES_ONLY
    VIVOXSDK_DLLEXPORT void vx_state_buddy_group_list_create(int size, vx_state_buddy_group_list_t* list_out);
    VIVOXSDK_DLLEXPORT void vx_state_buddy_group_list_free(vx_state_buddy_group_t** list, int size);
#endif
...
typedef struct vx_user_channel {
    ...
    */
     ...
     * If this function returns VX_E_BUFSIZE, then the buffer passed in is too small. The required 
     * size will be in *outsize, and the type will be in *outtype.
     * \ingroup fileio
     */
     ...
     * @param inputFile - the pathname to the VXR file to use as input
     * @param outputFile - the pathname to the wav file to be generated. Any existing file will be overwritten.
     * @param pfOnFrameExported - a function that is called on each frame export. This enables implementation of progress bar etc.
     * @param callbackHandle - a value that is passed back on the pfOnFrameExported callback.
     * \ingroup csr
     */
     ...
     * @param inputFile - the pathname to the VXR file to use as input
     * @param filePrefix - a prefix for the files that will be written.
     * @param pfOnFrameExported - a function that is called on each frame export. This enables implementation of progress bar etc.
     * @param callbackHandle - a value that is passed back on the pfOnFrameExported callback.
     * \ingroup csr
     */
