#ifndef __SimplygonSDKCrypticNW_h__
#define __SimplygonSDKCrypticNW_h__
...
namespace SimplygonSDK
{
	...
	public:
		...
		/**
		 * Detect triangle edge neighbours. Neighbour ids are stored in the "EdgeNeighbours"
		 * TriangleVertex field.
		 */
	...
	inline const rchar *GetInterfaceVersionHash()
		{
		return "6A57C6241352BCD12D0B7D0D4CDFAFC2F22BF384CBB0C185E66ECB1375378B2C";
		}

};

#endif//__SimplygonSDKCrypticNW_h__
