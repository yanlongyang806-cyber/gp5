...
#if _PS3 || defined(__sparc__) || defined(__hppa__) || defined(__ppc__) || defined(__mips__) || defined(_XBOX) || (defined(__MWERKS__) && !defined(__INTEL__))
...
#if !_PS3 && (defined(WORD64_AVAILABLE) && !defined(__alpha))
#define SLOW_WORD64
#endif
...
#elif (defined(__GNUC__) && !defined(__alpha)) || defined(__MWERKS__)
