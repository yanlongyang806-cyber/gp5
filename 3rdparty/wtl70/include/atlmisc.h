...
// Attributes
	...
	BOOL GetFileTitle(LPTSTR lpstrFileTitle, int cchLength) const
	{
		...
		_splitpath_s(szBuff, NULL, 0, NULL, 0, szNameBuff, sizeof(szNameBuff), NULL, 0);
	...
	CString GetFileTitle() const
	{
		...
		_splitpath_s(strFullName, NULL, 0, NULL, 0, strResult.GetBuffer(MAX_PATH), MAX_PATH, NULL, 0);
