...
RADCFUNC HRAD3D Open_RAD_3D( HWND window )
{
  ...
  rad_3d->nonpow2_textures_supported = !(Caps.TextureCaps & D3DPTEXTURECAPS_POW2);
  ...
  rad_3d->width =  r.right - r.left;
  rad_3d->height = r.bottom - r.top;
  
  D3DVIEWPORT9 vp = { 0, 0, rad_3d->width, rad_3d->height, 0.0f, 1.0f };
...
static void Setup_Renderstate( HRAD3DIMAGE rad_image, F32 alpha_level, S32 pre )
{
  ...
  rad_image->direct_3d_device->SetSamplerState( 0, D3DSAMP_ADDRESSU, D3DTADDRESS_CLAMP );
  rad_image->direct_3d_device->SetSamplerState( 0, D3DSAMP_ADDRESSV, D3DTADDRESS_CLAMP );
