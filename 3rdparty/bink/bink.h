...
#define BINKVERSION "1.9u"
#define BINKDATE    "2010-04-25"
...
typedef U32 (RADLINK PTR4*  BINKTIMERREAD)     (void);
...
RADEXPFUNC char PTR4* RADEXPLINK BinkBufferGetError( void );
