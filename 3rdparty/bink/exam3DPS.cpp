...
static void Show_frame( void )
{
  ...
  d3d_device->Clear( 0, NULL, D3DCLEAR_TARGET, D3DCOLOR_XRGB(0,10,80), 1.0f, 0 );
                                 ...
                                 HINSTANCE previous_instance )
{
  ...
  //
  // Return the new window with a tiny initial default size (it is resized later on).
  //
...
// @cdep pre $requires(binktexturesDX9.cpp)
