                                 ...
                                 S32 is_premultiplied_alpha )
{
  ...
  else
  {
    ...
    rad_image->direct_3d_device->SetRenderState( D3DRENDERSTATE_SRCBLEND, ( is_premultiplied_alpha ) ? D3DBLEND_ONE : D3DBLEND_SRCALPHA );
  ...
  rad_image->direct_3d_device->SetTextureStageState( 0, D3DTSS_MAGFILTER, D3DTFG_LINEAR );
  rad_image->direct_3d_device->SetTextureStageState( 0, D3DTSS_MINFILTER, D3DTFN_LINEAR );
