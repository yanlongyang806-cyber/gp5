...
#define __cudaRegisterEntry(fun, thread_limit) \
        __cudaRegisterFunction(__cudaFatCubinHandle, (const char*)__device_stub_##fun, (char*)__device_fun(fun), #fun, thread_limit, __ids)
